...
//            this.label_credit_config.setString(SDHRoomModel.getClubGlodCfg());
//        }
//
...
//
//        var img1 = new cc.Sprite("res/res_sdh/jiesuan/dia.png");
//        img1.setAnchorPoint(0.5,1);
//        img1.setPosition(cc.winSize.width/2,cc.winSize.height);
//        this.addChild(img1);
//
//        var img_title = new cc.Sprite("res/res_sdh/jiesuan/paijiujiesuan.png");
...
//
//        this.btn_back = new ccui.Button("res/res_sdh/jiesuan/back.png","res/res_sdh/jiesuan/back.png");
...
var SDHBigResultItem = cc.Node.extend({
    ...
    initNode:function(){
        var img = "res/res_sdh/jiesuan/image_toumingdi.png";
        this.nodeBg = new cc.Scale9Sprite(img);
        this.nodeBg.setContentSize(1710,165);
        this.addChild(this.nodeBg);

        this.headBg = new cc.Sprite("res/res_sdh/touxiangkuang.png");
        ...
        this.icon_fangzhu = new cc.Sprite("res/res_sdh/jiesuan/fangzhu.png");
    ...
    setItemWithData:function(data,isFangZhu){
        if(data.seat == SDHRoomModel.mySeat){
            this.nodeBg.initWithFile("res/res_sdh/jiesuan/image_zijidi.png",cc.rect(0,0,116,113),cc.rect(38,38,38,38));
            this.nodeBg.setContentSize(1710,165);
        }
        ...
        if(SDHRoomModel.isClubGoldRoom()){
            ...
            this.setNumLabel(this.label_credit,data.winLoseCredit,"豆:");
        }
    ...
    showMoneyIcon:function(label){
        ...
        icon.setPosition(label.x - label.width/2 -10,label.y);
...
var SDHBigResultLayer = PKBigResultPop.extend({
    user:null,
    ...
    selfRender: function () {
        ...
        //显示部分房间信息
        var wanfaDesc = ClubRecallDetailModel.getSpecificWanfa(SDHRoomModel.intParams);
        ...
        var jushuStr = "第" + SDHRoomModel.nowBurCount + "/" + SDHRoomModel.totalBurCount + "局";
        this.getWidget("Label_jushu").setString(jushuStr);

        this.getWidget("Label_roomnum").setString("房号:" + SDHRoomModel.tableId);

        this.getWidget("Label_score").setString("");
        if (SDHRoomModel.isCreditRoom()){
            this.getWidget("Label_score").setString(SDHRoomModel.getCreditConfigStr());
        }

        if(SDHRoomModel.isClubGoldRoom()){
            this.getWidget("Label_score").setString(SDHRoomModel.getClubGlodCfg());
        }
    },
