...
var SDHOptBtnLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        this.btn_tishi.setPosition(-300,this.localY);
        ...
        this.btn_chupai.setPosition(300,this.localY);
        ...
        this.btn_maipai = new ccui.Button("res/res_yybs/mp.png","res/res_yybs/mp.png","");
