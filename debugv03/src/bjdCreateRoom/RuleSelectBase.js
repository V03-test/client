...
var RuleSelectBase = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        this.scrollView.setContentSize(1500,600);
        this.scrollView.setInnerContainerSize(this.scrollView.getContentSize());
        this.scrollView.setPosition(cc.winSize.width/2 - 560,230);
        ...
        for(var i = 0;i<this.layoutArr.length;++i){
            ...
            if(i > 0){
                var line = new cc.Sprite("res/res_ui/homeLayer/createRoom/createroom_img_line.png");
...
var SelectBox = ccui.Widget.extend({
    ...
    changeTarget:null,
    changeCb:null,
    ctor:function(type,labelStr,isQyqBisai){//isQyqBisai,亲友苑擂台房设置颜色标记字段
        this._super();

        this.selectType = type;
        this.labelStr = labelStr;

        this.isQyqBisai = isQyqBisai;
    ...
    initWidget:function(){
        var resFile1 = "res/res_ui/qyq/common/commonButton/checkBox2.png";
        var resFile2 = "res/res_ui/qyq/common/commonButton/toggleBox2.png";
        ...
        this.itemLabel = UICtor.cLabel(this.labelStr,36,null,cc.color("#90371f"));
    ...
    setLabelColor:function(){
        var color = cc.color("#8a3119");
        if(this.checkBox.isSelected()){
           color = cc.color("#e3532d");
        }
        if(this.isQyqBisai){
            color = cc.color("#ffffff");
            if(this.checkBox.isSelected()){
                color = cc.color("#FFF0E60C");
            }
        }
...
var changeEditBox = ccui.Widget.extend({
    ...
    initWidget:function () {
        ...
        var BoxBg = new cc.Scale9Sprite("res/res_ui/homeLayer/createRoom/imgBg.png");
        BoxBg.setAnchorPoint(0,0.5);
        var reduceBtn = new ccui.Button();
        reduceBtn.loadTextureNormal("res/res_ui/qyq/common/commonButton/jian.png");
        ...
        addBtn.loadTextureNormal("res/res_ui/qyq/common/commonButton/jia.png");
