...
var HSTHRoomLayer = HSTHBaseRoomLayer.extend({
    ...
    initLayer:function(){
        ...
        this.paiZhuoFen.setPosition(100,cc.winSize.height - 250);
        ...
        tongji_bg.setPosition(150,cc.winSize.height - 135);
    ...
    addRoomTitle:function(){
        var spr = new cc.Sprite("res/res_hsth/hsth.png");
    ...
    addBottomBtn:function(){
        ...
        this.btn_yuyin.setPosition(cc.winSize.width - 90,590);
    ...
    handleTableData:function(type,data){
        ...
        if(type == HSTHTabelType.CreateTable){
            ...
            //var message = {closingPlayers:[{userId:2517495,name:"lx67",leftCardNum:0,point:300,totalPoint:300,boom:0,winCount:0,lostCount:0,
            //    maxPoint:0,totalBoom:0,cards:[],seat:1,sex:2,icon:"res/res_icon/15.png",isHu:1,actionCounts:[1,285,1,0],gangIds:[],dahus:[],
            //    xiaohus:[],ext:[0,80,285,1,2,285,285,0,30000,0,],gold:null,credit:null,winLoseCredit:30000,commissionCredit:0,
            //    goldFlag:null},{userId:7664459,name:"lx45",leftCardNum:5,point:-300,totalPoint:-300,boom:0,winCount:0,lostCount:0,maxPoint:0,
            //    totalBoom:0,cards:[314,414,214,414,114],seat:2,sex:1,icon:"res/res_icon/20.png",isHu:0,actionCounts:[0,145,0,0],gangIds:[],
            //    dahus:[],xiaohus:[],ext:[0,-80,145,2,1,145,145,0,-30000,0,],gold:null,credit:null,winLoseCredit:-30000,
            //    commissionCredit:0,goldFlag:null}],bird:[],birdSeat:[],isBreak:0,wanfa:259,ext:[992053,7664459,"2021-01-08 18:29:31",
            //    259,1,1,0,1,1,3,1,0,7496,1,10000,100,100,0,1,1,0,1],matchExt:[],cutCard:[],cutDtzCard:[],
            //    groupLogId:null,intParams:[]}
            //
            //ClosingInfoModel.init(message);
            //
            //var SmallResultLayer = HSTHRoomModel.getBigResultLayer();
