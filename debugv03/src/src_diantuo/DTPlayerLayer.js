    ...
    onFastChat:function(event){
        ...
        if(id < 0){
            ...
            if(id >= 200){
                ...
                var realPath = "res/res_diantuo/sound/"+path+ "fixMsg/fix_msg_" + (id - 100) +".mp3";
...
var DTPlayerNode = cc.Node.extend({
    ...
    setDiPaiVisible:function(isBool){
        ...
        this.txt_shengyu.setOpacity(!!isBool ? 255 : 0);
        this.label_num.setOpacity(!!isBool ? 255 : 0);
    },
    ...
    setUserScoreWithData:function(data){
        ...
        if(DTRoomModel.intParams[16] == 1){//炸弹有喜
            this.extFenTip.initWithFile("res/res_diantuo/xifen.png");
            this.label_ext_score.setString(data.ext[1] || 0);
        }else{
            this.extFenTip.initWithFile("res/res_diantuo/zongfen.png");
    ...
    setYouSpr:function(data){
        ...
        if(data.ext[7] > 0){
            this.youSpr.initWithFile("res/res_diantuo/you_" + data.ext[7] + "_icon.png");
    ...
    setTipSpr:function(type){
        ...
        if(type == 1){
            ...
            this.tipSpr.initWithFile("res/res_diantuo/duzhan.png");
        }else if(type == 2){
            this.tipSpr.setVisible(true);
            this.tipSpr.initWithFile("res/res_diantuo/team_icon.png");
        }else{
    ...
    initNode:function(){
        var playerBg = new cc.Sprite("res/res_yybs/playerBg.png");
        playerBg.setAnchorPoint(0,0.5);
        this.addChild(playerBg);
        this.playerBg = playerBg;

        var headKuang = new cc.Sprite("res/res_gameCom/header_mask.png");
        this.addChild(headKuang);

        var sten=new cc.Sprite("res/res_gameCom/header_mask.png");
        var clipnode = new cc.ClippingNode();
        clipnode.setStencil(sten);
        clipnode.setAlphaThreshold(0.8);
        this.iconSpr = new cc.Sprite("res/res_gameCom/default_m.png");
        this.iconSpr.setScale(120/this.iconSpr.width);
        clipnode.addChild(this.iconSpr);
        this.addChild(clipnode);

        this.infobg = new cc.Sprite("res/res_diantuo/xinxi_di.png");
        this.infobg.opacity = 0;
        this.addChild(this.infobg);

        this.fenbg1 = new cc.Sprite("res/res_diantuo/fenshu_di.png");
        this.fenbg1.opacity = 0;
        this.addChild(this.fenbg1);

        var tip1 = new cc.Sprite("res/res_diantuo/chifen.png");
        tip1.setPosition(tip1.width/2,this.fenbg1.height/2);
        this.fenbg1.addChild(tip1);

        this.fenbg2 = new cc.Sprite("res/res_diantuo/fenshu_di.png");
        this.fenbg2.opacity = 0;
        this.addChild(this.fenbg2);

        var tip2 = new cc.Sprite("res/res_diantuo/zongfen.png");
        ...
        this.image_coin = new cc.Sprite("res/res_diantuo/img_jinbi.png");
        ...
        this.icon_tuoguan = new cc.Sprite("res/res_gameCom/tuoguan.png");
        this.addChild(this.icon_tuoguan,2);


        this.icon_ip_same = new cc.Sprite("res/res_gameCom/ipsame.png");
        this.icon_ip_same.setScale(0.9);
        this.addChild(this.icon_ip_same,2);
        this.spr_out_line = new cc.Sprite("res/res_gameCom/img_zl.png");
        this.addChild(this.spr_out_line,3);

        this.icon_zhunbei = new cc.Sprite("res/res_diantuo/zhunbei.png");
        this.addChild(this.icon_zhunbei);

        this.yybg = new cc.Sprite("res/res_gameCom/img_yybg.png");
        this.yybg.setAnchorPoint(1,0.5);
        this.yybg.setVisible(false);
        this.addChild(this.yybg);

        this.yyts = new cc.Sprite("res/res_gameCom/img_yyts.png");
        ...
        this.warningSpr = new cc.Sprite("res/res_diantuo/warning.png");
        this.addChild(this.warningSpr);

        this.tipSpr = new cc.Sprite("res/res_diantuo/duzhan.png");
        this.addChild(this.tipSpr,3);

        this.paiBei = new cc.Sprite("res/res_diantuo/paibei.png");
        ...
        this.baoWangBg = new cc.Scale9Sprite("res/res_diantuo/jiugonga1.png");
        ...
        this.yaobuqiSpr = new cc.Sprite("res/res_diantuo/yaobuqi.png");
    ...
    setPosWithIdx:function(idx){
        ...
        switch (idx) {
            case 0:
                ...
                this.label_score.setPosition(205,-40);
                this.label_ext_score.setPosition(400,-40);

                this.label_sai.setAnchorPoint(0,0.5);
                this.label_sai.setPosition(280,0);
                this.label_coin.setPosition(300,0);

                this.image_coin.setPosition(280,0)
            ...
            case 1:
                ...
                this.label_score.setPosition(38,-135);
                this.label_ext_score.setPosition(38,-180);
                this.label_sai.setPosition(0,-215);

                this.image_coin.setPosition(-60,-220)
                this.label_coin.setPosition(-38,-220);
            ...
            case 2:
                ...
                this.label_score.setPosition(205,15);
                this.label_ext_score.setPosition(205,-30);

                this.label_sai.setPosition(160,-65);

                this.image_coin.setPosition(100,-70)
                this.label_coin.setPosition(120,-70);
        ...
        this.playerBg.visible = idx != 0;
        if(idx != 0 && idx != 2){
            this.playerBg.setAnchorPoint(0,0.5);
            this.playerBg.setRotation(90);
            this.playerBg.setPositionY(68);
        }
    },
