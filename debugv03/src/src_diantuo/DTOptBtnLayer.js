...
var DTOptBtnLayer = cc.Layer.extend({
    ...
    showNoDaTip:function(isShow){
        if(isShow){
            if(!this.nodaSpr){
                this.nodaSpr = new cc.Scale9Sprite("res/res_erddz/rangPaiBg.png");
    ...
    initLayer:function(){
        ...
        this.btn_buyao.setPosition(-400,0);
        ...
        this.btn_tishi.setPosition(50,0);
        ...
        this.btn_chupai.setPosition(400,0);
