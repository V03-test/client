...
var YJMJSmallResultPop = BasePopup.extend({
    ...
    createHuedPais: function(widget,user) {
        ...
        for(var i = 0;i<infoArr.length;++i){
            ...
            var img_spr = new cc.Sprite("res/res_mj/mjRoom/" + img + ".png");
            ...
            if(img == "icon_zn"){
                ...
                for(var t = 0;t<myBirdArr.length;++t){
                    ...
                    card.setScale(0.5);
                    card.setPosition(startX + t*90,img_spr.y - 105);
                    hutxt.addChild(card);
                }
            }
    ...
    selfRender: function () {
        ...
        if (MJRoomModel.nowBurCount == MJRoomModel.totalBurCount || (this.data.ext[17] == 1)) {
