...
var TJMJRoom = BaseRoom.extend({
    ...
    selfRender:function(){
        ...
        var wangNode = new cc.Node();
        this.Panel_20.addChild(wangNode,1);
        this.wangNode = wangNode;
    },
    ...
    showLiangWangAni:function(id,index){
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.TJMJ){
            ...
            this.wangNode.addChild(this.wang_card);
        }
    },
