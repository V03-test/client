...
var YZWDMJRoom = BaseRoom.extend({
    ...
    selfRender:function(){
        ...
        //this.recordBtn.setTexture("res/res_mj/mjRoom/btn_yuyin_normal.png");
        //this.recordBtn.scale = 0.73;
        //this.recordBtn.x = 1241 + (cc.winSize.width - SyConfig.DESIGN_WIDTH)/2 - disXForIphoneX ;
    ...
    refreshButton:function(selfAct){
        ...
        if(selfAct.length>0){
            ...
            if(selfAct[6] == 1 && selfAct[7]==1){
                textureMap[6] = {t:"res/res_mj/res_yzwdmj/yzwdmjRoom/mj_btn_hu_wd.png",v:1102};
                textureMap[7] = {t:"res/res_mj/res_yzwdmj/yzwdmjRoom/mj_btn_hu_wc.png",v:1101};
            }
            ...
            this.hbtns[rIndex].loadTextureNormal("res/res_mj/res_yzwdmj/yzwdmjRoom/mj_btn_guo.png");
