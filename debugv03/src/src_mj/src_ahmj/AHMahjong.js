...
var AHMahjong = ccui.Widget.extend({
    ...
    onTouchHandler:function(obj,type){
        ...
        if((MJRoomModel.wanfa == GameTypeEunmMJ.KWMJ || MJRoomModel.isYYNXMJ()) && MJRoomModel.mj_xianjia_oprete){
            return false;
        }
        ...
        if(type == ccui.Widget.TOUCH_BEGAN){
            if(!this.selected){
                ...
                if(MJRoomModel.isTingSelecting){
                    ...
                    if(this._cardVo && this._cardVo.i == 201 && !MJRoomModel.isTCPFMJ() && !MJRoomModel.isTCDPMJ()){
                    ...
                    }else if(this._cardVo.chunwang == 1 && MJRoomModel.wanfa == GameTypeEunmMJ.KWMJ){
                        self.selected = false;
                        self.x = self.initX;
                        self.y = self.initY;
                    }else{
    ...
    diplay:function(){
        ...
        if (this._cardVo.zhuan == 1){
            ...
            if (direct == 1){
                var wang_logo = new cc.Sprite("res/res_mj/res_ahmj/tcmjRoom/mj_zhuan_big.png");
                wang_logo.setAnchorPoint(1,1);
                wang_logo.setPosition(bg.width,bg.height);
                this.addChild(wang_logo,9999);
            }else{
                var wang_logo = new cc.Sprite("res/res_mj/res_ahmj/tcmjRoom/mj_zhuan.png");
                this.addChild(wang_logo,9999);
                if(direct ==3){
                    wang_logo.setPosition(60,96);
                }else if (direct ==2){
        ...
        if (this._cardVo.zhengwang == 1 || this._cardVo.chunwang == 1){
            ...
            if (direct == 1){
                var wang_logo = new cc.Sprite("res/res_mj/res_ahmj/kwmjRoom/mj_"+string+"_big.png");
                wang_logo.setAnchorPoint(1,1);
                wang_logo.setPosition(bg.width,bg.height);
                this._bg.addChild(wang_logo,9999);
            }else{
                var wang_logo = new cc.Sprite("res/res/res_mj/res_ahmj/kwmjRoom/mj_"+string+".png");
                this.addChild(wang_logo,9999);
                if(direct ==3){
                    wang_logo.setPosition(60,96);
                }else if (direct ==2){
    ...
    displayTingArrows:function(tingList,huCardNum){
        if(!this._bg.getChildByTag(1008)) {
            if (this._displayVo.direct == 1) {
                ...
                var numLabel_1 = new ccui.Text("", "res/font/bjdmj/fzcy.ttf", 36);
                numLabel_1.setString("听");
                numLabel_1.y = size.height*0.6;
                numLabel_1.x = size.width*0.48;
