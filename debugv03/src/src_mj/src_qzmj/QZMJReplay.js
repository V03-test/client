/**
 * Created by Administrator on 2021/2/5 0005.
 */
var QZMJReplay = BaseLayer.extend({
    ...
    onSpeed: function() {
        if (this.playIntval == 1.2) {
            this.playIntval = 0.6;
            this.BitmapLabel_speed.setString("x 2");
        } else if(this.playIntval == 0.6) {
            this.playIntval = 0.35;
            this.BitmapLabel_speed.setString("x 4");
        } else if(this.playIntval == 0.35) {
            this.playIntval = 1.2;
            this.BitmapLabel_speed.setString("x 1");
        }
    },
    ...
    onLeft:function(){
        this.replay.loadTextureNormal("res/res_mj_common/mjReplay/playback5.png");
        this.autoPlay = false;
    ...
    onPlay:function(){
        if(this.autoPlay){
            ...
            this.replay.loadTextureNormal("res/res_mj_common/mjReplay/playback3.png");
    ...
    initData:function(flag){
        ...
        this.showLiangWangAni(MJReplayModel.qzmj_wangID);//显示王牌
    ...
    playing:function(){
        ...
        if(step){
            ...
            if(MJReplayModel.step==(MJReplayModel.steps.length-1)){
                var mc = new QZMJSmallResultPop(MJReplayModel.closingMsg,true);
                if (mc)
    ...
    showTJMJGang:function(acts){
        if(acts.length > 0){
            if(!this.TJMJGang_Panel){
                var bg = new cc.Scale9Sprite("res/res_mj_common/mjRoom/img_ting1.png");
