...
var CSMJRoom = BaseRoom.extend({
    ...
    selfRender:function(){
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.TDH){
            this.bgColor = cc.sys.localStorage.getItem("pro003_mj_pz"+MJRoomModel.wanfa)|| 3;
        }
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.NYMJ || (MJRoomModel.wanfa == GameTypeEunmMJ.CSMJ && MJRoomModel.isMoneyRoom())){
        ...
        if(MJRoomModel.renshu == 4){
            ...
            //this.getWidget("mPanel"+4).x += 50;
            //this.getWidget("mPanel"+2).x -= 80;
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.TDH){
            ...
            this.btn_auto_play.setTitleFontSize(60);
            this.btn_auto_play.setTitleColor(cc.color.YELLOW);
            this.btn_auto_play.setPosition(cc.winSize.width - 200,280);
        ...
        //this.Label_info_mj.setVisible(false);
    ...
    initwanfaImg:function(){
        var wanfaStr = ClubRecallDetailModel.getSpecificWanfa(MJRoomModel.intParams,false,false,MJRoomModel.isMoneyRoom());
        ...
        if(isShow){
            if(!this.piaoBtnNode){
                ...
                if(MJRoomModel.wanfa == GameTypeEunmMJ.NXMJ){
                    imgArr = ["bupiao.png","1fen.png","2fen.png","4fen.png"];
                    tagArr = [0,1,2,4];
                }
                var offsetX = 300;
                var startX = -(imgArr.length - 1)/2*offsetX;
    ...
    csGangMoPai:function(seat){
        ...
        if(seat == MJRoomModel.mySeat){
            ...
            for(var i = 0;i<playIds.length;++i){
                ...
                if(MJRoomModel.wanfa == GameTypeEunmMJ.TDH){
                    delay += 1.2;
                }else if(MJRoomModel.wanfa == GameTypeEunmMJ.NXMJ){/**  宁乡麻将自己摸牌出牌时间缩短 */
                    delay += 0.3;
                }else{
                    delay += 0.5;
                }
    ...
    onShowAllHuCards:function(event){
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.NYMJ){
            this.onShowHuPanel(tingData.isShow?1:0);
        }else{
        ...
        if (huList && huList.length > 0){
            ...
            if (isShowAllTime === 1){
                ...
                if(MJRoomModel.wanfa == GameTypeEunmMJ.NYMJ){
                    ...
                    this.Panel_hupai.visible = !this.Panel_hupai.visible;
                }
            }
            // if(MJRoomModel.wanfa == GameTypeEunmMJ.TJMJ){
            //     scale_num = 0.5;
            //     if ((huList.length == 1 && huList[0] == 201) || huList.length > 14){
            //     this.Panel_hupai.width = 14 * 100*scale_num + 20;
            ...
            //     }
            // }else{
                if ((huList.length == 1 && huList[0] == 201) || (huList.length > 9 && huList.length <= 18)){
                    this.Panel_hupai.width = 9 * 90*scale_num+ (9-1)*30+60+100;
                    this.Panel_hupai.height = 420;
                    this.Panel_hupai.setAnchorPoint(0,0);
                }else if ((huList.length == 1 && huList[0] == 201) || huList.length > 18){
                    this.Panel_hupai.width = 9 * 90*scale_num+ (9-1)*30+60+100;
                    this.Panel_hupai.height = 800;
                    this.Panel_hupai.setAnchorPoint(0,0);
                }else{
    ...
    onJixuFromResult:function(){
        ...
        if(MJRoomModel.totalBurCount == MJRoomModel.nowBurCount
            || (MJRoomModel.wanfa == GameTypeEunmMJ.CSMJ && ClosingInfoModel.ext[24] == 1)
            || (MJRoomModel.wanfa == GameTypeEunmMJ.JZMJ && ClosingInfoModel.ext[24] == 1)
            || (MJRoomModel.wanfa == GameTypeEunmMJ.TJMJ && ClosingInfoModel.ext[24] == 1)
            || (MJRoomModel.wanfa == GameTypeEunmMJ.GDCSMJ && ClosingInfoModel.ext[24] == 1)
            || (MJRoomModel.wanfa == GameTypeEunmMJ.NXMJ && ClosingInfoModel.ext[24] == 1)
            || (MJRoomModel.wanfa == GameTypeEunmMJ.NYMJ && ClosingInfoModel.ext[24] == 1)
            || (MJRoomModel.wanfa == GameTypeEunmMJ.TCMJ && ClosingInfoModel.ext[24] == 1)
            || (MJRoomModel.wanfa == GameTypeEunmMJ.TDH && ClosingInfoModel.ext[17] == 1)){
    ...
    onOver:function(event){
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.CSMJ || MJRoomModel.wanfa == GameTypeEunmMJ.TDH
            || MJRoomModel.wanfa == GameTypeEunmMJ.JZMJ){//长沙麻将、推倒胡加大胡音效
            this.playDaHu();
        }
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.NXMJ){/** 宁乡麻将小结延时 **/
            t = 3000;
        }
    ...
    initData:function(){
        ...
        for(var i=0;i<players.length;i++){
            ...
            var point = -1;
            if((MJRoomModel.wanfa == GameTypeEunmMJ.CSMJ && MJRoomModel.ext[15] == 1)
                || (MJRoomModel.wanfa == GameTypeEunmMJ.TDH && MJRoomModel.ext[8] == 1)
                || (MJRoomModel.wanfa == GameTypeEunmMJ.NXMJ && MJRoomModel.ext[15] == 1)
                || (MJRoomModel.wanfa == GameTypeEunmMJ.TJMJ && MJRoomModel.ext[15] == 1)){
                point = p.ext[3];
            }
            if(MJRoomModel.wanfa != GameTypeEunmMJ.TCMJ && MJRoomModel.wanfa != GameTypeEunmMJ.NYMJ){
        ...
        if(isContinue){
            ...
            if((MJRoomModel.wanfa == GameTypeEunmMJ.NYMJ && MJRoomModel.nymjHasPlay) || MJRoomModel.wanfa != GameTypeEunmMJ.NYMJ){
                if (this.wang_card){
                    if(this.tjmjDipaiLabel){
                        this.tjmjDipaiLabel.removeFromParent();
                        this.tjmjDipaiLabel = null;
    ...
    updateRoomInfo:function(color){
        // cc.log("color =",color);
        MJRoomModel.tempNowBurCount = MJRoomModel.nowBurCount;
    ...
    startGame:function(event){
        ...
        this.initCards(direct,p.handCardIds,[],[],[],false, p.handCardIds.length == 14,true);
    ...
    showLiangWangAni:function(id,index){
        ...
        var scale = 0.6;
        if(MJRoomModel.wanfa != GameTypeEunmMJ.TJMJ){//不是桃江就展示王图标
            vo.wang = 1;
        }
        if(MJRoomModel.wanfa == GameTypeEunmMJ.NYMJ && MJRoomModel.nymjHasPlay){
            if(!this.wang_card){
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.TJMJ){
            ...
            if(MJRoomModel.wanfa == GameTypeEunmMJ.NYMJ){
                if(MJRoomModel.nymjGetData){
                    ...
                    var self = this;
                    this.wang_card.y = 530;
                    this.wang_card.x = 960;
                    self.wang_card.setAnchorPoint(0.5,0.5);
                    this.wang_card.scale = 1.8/1.5;
                    var moveAct = cc.moveTo(0.1,cc.p(1060,530));
    ...
    //                this.Button_xiaohu.loadTextureNormal("res/res_mj/res_csmj/btn_cs_xiaohu_"+(i+1)+".png");
    //                break;
    //            }
    //        }
    //    }
    ...
    cleanButtonAni:function(){
        for (var k = 0; k < this.hbtns.length; k++) {
            if(this.hbtns[k].getChildByName("buttonAni")){
                this.hbtns[k].loadTextureNormal("res/res_mj/mjRoom/mj_btn_guo.png");
    ...
    refreshButtonForYLC:function(selfAct) {
        ...
        if(selfAct.length>0){
            ...
            localBtn.push({t:"res/res_mj/mjRoom/ylc_mjguo.png",v:5,index:0});
            ...
            for(;localIndex < localBtn.length;++localIndex){
                ...
                // cc.log("aniResMap[tm.v] =",JSON.stringify(aniResMap[tm.v]));
                if(aniResMap[tm.v]){
                    this.hbtns[localIndex].loadTextureNormal("res/res_mj/mjRoom/mj_btn_guo.png");
                    ccs.armatureDataManager.addArmatureFileInfo("res/bjdani/YLCMjButtonAni/"+aniResMap[tm.v].t+"/"
                        +aniResMap[tm.v].t+".ExportJson");
                    var armature = new ccs.Armature(aniResMap[tm.v].t);
                    armature.getAnimation().play("Animation1", -1, -1);
                    this.hbtns[localIndex].addChild(armature);
                    armature.x = this.hbtns[localIndex].width/2;
                    armature.y = this.hbtns[localIndex].height/2 - 30;
    ...
    refreshButtonForNormal:function(selfAct){
        ...
        if(selfAct.length>0){
            ...
            if(MJRoomModel.wanfa != GameTypeEunmMJ.CSMJ && MJRoomModel.wanfa != GameTypeEunmMJ.JZMJ){
                //过
                this.hbtns[rIndex].visible = true;
    ...
    onGetMajiang:function(event){
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.NXMJ){
            ...
            var delayTime = 0;
            if(this.isAleayGang){
                this.isAleayGang = false;
                delayTime = 2500;
            }
            setTimeout(function(){
                self.moPaiAction(id,seat,selfAct);
            },delayTime);
        }else{
            this.moPaiAction(id,seat,selfAct);
        }
    },

    moPaiAction:function(id,seat,selfAct){
     ...
     * @param userId
     */
    chuPaiAction:function(id,seat,direct,userId,isCsGang,endPos){
        ...
        this.layouts[direct].chuPai(vo,isCsGang,endPos);
    ...
    delayPlayChuPai:function(id,seat,direct,userId,delay,isCsGang,endPos){
        cc.log("===========delayPlayChuPai==========",id);
        if(delay > 0){
            this.runAction(cc.sequence(cc.delayTime(delay),cc.callFunc(function(){
                this.chuPaiAction(id,seat,direct,userId,isCsGang,endPos);
            }.bind(this))));
        }else{
            this.chuPaiAction(id,seat,direct,userId,isCsGang,endPos);
        }
    ...
    onLetOutCard:function(event){
        ...
        if(seat==MJRoomModel.mySeat){
            if(MJRoomModel.tempNowBurCount != MJRoomModel.nowBurCount){
                this.updateRoomInfo();
            }
        }
        ...
        if(seat==MJRoomModel.mySeat&&action==0&&ids.length>0&&!simulate){
            if(this.getLayout(1).getOneMahjongOnHand(ids[0])==null) {
                ...
                //靖州麻将打第一张听牌显示听牌按钮
                if(MJRoomModel.wanfa == GameTypeEunmMJ.JZMJ && selfAct){
                    this.refreshButton(selfAct);
                }
        ...
        switch (action){
            ...
            case MJAction.CHU_PAI://出牌动作
                ...
                //长沙麻将开杠有可能出多张牌
                if(ids.length == 1){
                    this.chuPaiAction(ids[0],seat,direct,userId,null,message.endPos);
            ...
            case MJAction.TING://听牌特殊处理，先出牌，再播听牌动画
                ...
                MJRoomSound.actionSound(userId,prefix);
                if (ids.length>0) {
                    self.chuPaiAction(ids[0],seat,direct,userId,null,message.endPos);
                }
                //if (seat == MJRoomModel.mySeat) {
            ...
            default://补张、吃、碰、杠牌动作
                ...
                if(action==MJAction.GANG && MJRoomModel.wanfa == GameTypeEunmMJ.GDCSMJ){
        ...
        this.refreshButton(selfAct);
        if(MJRoomModel.wanfa != GameTypeEunmMJ.TJMJ && MJRoomModel.wanfa != GameTypeEunmMJ.TCMJ){
            if(action != MJAction.XIAO_HU && action != MJAction.HIDE_XIAOHU){
                this.clearTingArrows();
            }
        }

        if(MJRoomModel.wanfa == GameTypeEunmMJ.TDH && seat == MJRoomModel.mySeat && this.btn_auto_play.btnType == 0){
        ...
        if(seat == MJRoomModel.mySeat && (MJRoomModel.wanfa == GameTypeEunmMJ.NYMJ 
            || (MJRoomModel.wanfa == GameTypeEunmMJ.CSMJ && MJRoomModel.isMoneyRoom()))){
            this.Panel_hupai.setVisible(false);
        }
    ...
    onJoin:function(event){
        ...
        if (MJRoomModel.renshu != 2 && !MJRoomModel.isMoneyRoom()){
            var seats = MJRoomModel.isIpSame();
            if(seats.length>0){
                for(var i=0;i<seats.length;i++) {
                    this._players[seats[i]].isIpSame(true);
