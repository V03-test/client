...
var ChatPop = BasePopup.extend({
    ...
    selfRender: function () {
        ...
        if (this.main2){
            this.main2.x = (cc.winSize.width - SyConfig.DESIGN_WIDTH) /2 + 1480;
        }else if(this.mainPopup){
            this.mainPopup.x = (cc.winSize.width - SyConfig.DESIGN_WIDTH) /2 + 1480;
        }
    },
