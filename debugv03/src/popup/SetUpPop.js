...
var PHZSetUpPop = BasePopup.extend({
    ...
    selfRender: function () {
        ...
        //桌面背景
        var widgetZmbj = {"Button_zmbj1":1,"Button_zmbj2":2,"Button_zmbj3":3,
            "Image_zmbj1":1,"Image_zmbj2":2,"Image_zmbj3":3};
    ...
    setDefaultAllData:function(){
        ...
        if (PHZRoomModel.wanfa == GameTypeEunmZP.AHPHZ && (!setAHPHZ || setAHPHZ != 1)){
            ...
            this.setLocalItem("pro003_phz_setAllData_Model"+PHZRoomModel.wanfa,1);
...
var MjSetUpPop = BasePopup.extend({
    ...
    selfRender: function () {
        ...
        this.pp = parseInt(this.getLocalItem("pro003_mj_pp"+MJRoomModel.wanfa))|| 3;
        this.pm = parseInt(this.getLocalItem("pro003_mj_pm"+MJRoomModel.wanfa))|| 1;
        this.pz = parseInt(this.getLocalItem("pro003_mj_pz"+MJRoomModel.wanfa))|| 2;

        if(this.isCSMJ && this.isYuyan){
            if(MJRoomModel.wanfa == GameTypeEunmMJ.DZMJ){
                this.yuyan = parseInt(this.getLocalItem("pro003_mj_yuyan"+MJRoomModel.wanfa)) || 2;
            }else{
                this.yuyan = parseInt(this.getLocalItem("pro003_mj_yuyan"+MJRoomModel.wanfa)) || 1;
            }
        }
    ...
    displayYuyan:function(){
        ...
        cc.sys.localStorage.setItem("pro003_mj_yuyan"+MJRoomModel.wanfa,this.yuyan);
    },

    displayPz:function(){
        this.getWidget("CheckBox_bg1").setSelected(this.pz==1);
        this.getWidget("CheckBox_bg2").setSelected(this.pz==2);
        cc.sys.localStorage.setItem("pro003_mj_pz"+MJRoomModel.wanfa,this.pz);
        SyEventManager.dispatchEvent(SyEvent.UPDATE_BG_YANSE,this.pz);
    },
    ...
    displayPp:function(){
        ...
        cc.sys.localStorage.setItem("pro003_mj_pp"+MJRoomModel.wanfa,this.pp);
...
var TCPFMjSetUpPop = BasePopup.extend({
    ...
    selfRender: function () {
        ...
        this.pp = parseInt(this.getLocalItem("pro003_mj_pp"+MJRoomModel.wanfa))||this.getLocalItem("pro003_mj_pp") || this.getDefaultCardBg();
        this.pm = parseInt(this.getLocalItem("pro003_mj_pm"+MJRoomModel.wanfa))||this.getLocalItem("pro003_mj_pm") || this.getDefaultCardFront();
        this.pz = parseInt(this.getLocalItem("pro003_mj_pz"+MJRoomModel.wanfa))||this.getLocalItem("pro003_mj_pz") || this.getDefaultBg();
...
var HBGZPSetUpPop = BasePopup.extend({
    ...
    getLocalRecord: function () {
        ...
        this.zpdx = parseInt(this.getLocalItem("pro003_phz_zpdx"+GameTypeEunmZP.HBGZP)) || HBGZPSetModel.getDefaultZpdx();  //1,2,3
...
var XPLPSetUpPop = BasePopup.extend({
    ...
    getLocalRecord: function () {
        this.kscp = PHZSetModel.kqtp;//parseInt(this.getLocalItem("pro003_phz_kscp"+GameTypeEunmZP.XPLP)) == 1 ? 1:0;  //1,0
        this.kqtp = PHZSetModel.kqtp;//(parseInt(this.getLocalItem("pro003_phz_kqtp"+GameTypeEunmZP.XPLP)) == 0 ? 0:1) || PHZSetModel.getDefaultKqtp();  //1,0
        this.yyxz = PHZSetModel.yyxz;//parseInt(this.getLocalItem("pro003_phz_yyxz"+GameTypeEunmZP.XPLP)) || PHZSetModel.getDefaultYyxz();  //1,2,3
        this.cpsd = PHZSetModel.cpsd;//this.getLocalItem("pro003_phz_cpsd"+GameTypeEunmZP.XPLP) || PHZSetModel.getDefaultCpsd();  //1,2,3
        this.zpdx = PHZSetModel.zpdx;//parseInt(this.getLocalItem("pro003_phz_zpdx"+GameTypeEunmZP.XPLP)) || PHZSetModel.getDefaultZpdx();  //1,2,3
        this.zmbj = PHZSetModel.zmbj;//this.getLocalItem("pro003_phz_zmbj"+GameTypeEunmZP.XPLP) || PHZSetModel.getDefaultZmbj();  //1,2,3
    },
    ...
    onKqtpClick: function (obj) {
        ...
        if (PHZSetModel.getValue("pro003_phz_kqtp") != this.kqtp){
            PHZSetModel.kqtp = this.kqtp;
            this.setLocalItem("pro003_phz_kqtp"+GameTypeEunmZP.XPLP,this.kqtp);
            SyEventManager.dispatchEvent(SyEvent.UPDATE_SET_KQTP,2);
        }
    },
    ...
    onCpsdClick: function (obj) {
        ...
        if (PHZSetModel.getValue("pro003_phz_cpsd") != this.cpsd){
            PHZSetModel.cpsd = this.cpsd;
            this.setLocalItem("pro003_phz_cpsd"+PHZSetModel.wanfa,this.cpsd);  //1,2,3
            SyEventManager.dispatchEvent(SyEvent.UPDATE_SET_CPSD);
        }
    },
    ...
    onZpdxClick: function (obj) {
        ...
        if (PHZSetModel.getValue("pro003_phz_zpdx") != this.zpdx){
            PHZSetModel.zpdx = this.zpdx;
            this.setLocalItem("pro003_phz_zpdx"+PHZSetModel.wanfa,this.zpdx);  //0,1
            SyEventManager.dispatchEvent(SyEvent.UPDATE_SET_ZPDX);
        }
        //cc.log("this.zpdx"+this.zpdx);
    },
    ...
    onZmbjClick: function (obj) {
        ...
        this.zmbj = values[temp-1];
        PHZSetModel.zmbj = this.zmbj;
        this.setLocalItem("pro003_phz_zmbj"+PHZSetModel.wanfa,this.zmbj);  //1,2,3
        SyEventManager.dispatchEvent(SyEvent.UPDATE_BG_YANSE);
    },
