...
var AHPHZCard = ccui.Widget.extend({
        ...
        if(type == ccui.Widget.TOUCH_BEGAN){
            ...
            if(isMyTurn && PHZRoomModel.selfAct.length==0){
                if (PHZRoomModel.getTouchCard() != this._cardVo.v){
                    ...
                    if(PHZRoomModel.wanfa == GameTypeEunmZP.WHZ || PHZRoomModel.wanfa == GameTypeEunmZP.LDS || PHZRoomModel.wanfa == GameTypeEunmZP.WCPHZ
    ...
    diplay:function(action){
        ...
        if(an==1){
            // scale = 0.5;
            bgPng = "small_half_back.png";//"big_half_back.png"
        }else{
        ...
        if (this._cardVo.ishu){ //当前胡的这张牌
            scale = 0.89;
            bgPng = "small_cards1_"+pmType+".png"
        }
