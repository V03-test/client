...
var XXEQSCard = ccui.Widget.extend({
            ...
            if(isMyTurn && PHZRoomModel.selfAct.length==0){
                if (PHZRoomModel.getTouchCard() != this._cardVo.v){
                    ...
                    if(PHZRoomModel.wanfa == GameTypeEunmZP.WHZ || PHZRoomModel.wanfa == GameTypeEunmZP.LDS
                        ...
                        || PHZRoomModel.wanfa == GameTypeEunmZP.YJGHZ){
    ...
    diplay:function(action){
        ...
        if(PHZRoomModel.wanfa == GameTypeEunmZP.YJGHZ && same == 1){
            same = 0;
            this.setGrayCanMove();
        }
    ...
    addOutCardType:function(card){
        var signImg  = this.tingImg = new cc.Sprite("res/res_phz/zzph/lan_small.png");
        signImg.x = 11;
        signImg.y = 74;
