...
/*        var mc = new ChatPop("res/phzChat.json");
    ...
    onSetUp:function(){
        ...
        //     //只有局数是当前局的时候， 才更新最终显示
        //     self.layouts[2].chiPai(ids,1,1,false);
    ...
    updateBgColor:function(){
        ...
        if (PHZSetModel.zmbj == 1){
            ...
            gameTypeUrl = "res/res_phz/wanfaImg/gametype3_6.png";
