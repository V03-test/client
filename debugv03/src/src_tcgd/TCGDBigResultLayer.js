...
var TCGDBigResultLayer = cc.Layer.extend({
    ...
    setLayerWithData:function(){
        ...
        if(TCGDRoomModel.isClubGoldRoom()){
            this.label_credit_config.setString(TCGDRoomModel.getClubGlodCfg());
        }
    ...
    initLayer:function(){
        ...
        var img_title = new cc.Sprite("res/res_tcgd/paijiujiesuan.png");
...
var TCGDBigResultItem = cc.Node.extend({
    ...
    initNode:function(){
        var img = "res/res_tcgd/score_di.png";
        ...
        this.headBg = new cc.Sprite("res/res_tcgd/touxiangkuang.png");
        this.headBg.setPosition(this.nodeBg.width/2,this.nodeBg.height - 90);
        this.nodeBg.addChild(this.headBg);

        this.icon_fangzhu = new cc.Sprite("res/res_tcgd/fangzhu.png");
        ...
        this.icon_dyj = new cc.Sprite("res/res_tcgd/icon_dyj.png");
        ...
        for(var i = 0;i<config.length;++i){
            ...
            txt.setPosition(45,this.nodeBg.height/2 + 15 - i*75);
    ...
    addScoreItem:function(scoreArr){
        ...
        for(var i = 0;i<scoreArr.length;++i){
            ...
            if(i == 1){
                ...
                var img = "res/res_tcgd/icon_sai.png";
    ...
    setItemWithData:function(data,isFangZhu,isDyj){
        ...
        }else if(TCGDRoomModel.isClubGoldRoom()){
            var credit = data.winLoseCredit;
