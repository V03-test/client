...
var DTZExfunc = {
    ...
    updateShowMap: function (dtzRoom , cardList) {
        ...
        DTZRoomModel.line1cardNumber = 0;
        DTZRoomModel.line2cardNumber = 0;
        cardList = dtzRoom._cards;
        if (DTZRoomModel.isProtectedSort()) {
            //cc.log("DTZRoomModel.firstLineLimit1...", dtzRoom.firstLineLimit);
            ...
            for (var index = 0; index < cardList.length; index++) {
                ...
                if (index > DTZRoomModel.firstLineLimit) {
        ...
        for (var curCardIndex = 0; curCardIndex < cardList.length; curCardIndex++) {
            ...
            if (showLine == 1) {
                DTZRoomModel.line1cardNumber++;
            } else {
                DTZRoomModel.line2cardNumber++;
            }
        }
        cc.log(showLine,"规划后...第一行显示" + DTZRoomModel.line1cardNumber + "张 第二行显示" + DTZRoomModel.line2cardNumber + "张");
    },
    ...
    isOverLine: function (dtzRoom , index, curCards) {
        ...
        if (index > DTZRoomModel.firstLineLimit) {
            ...
            if (dtzRoom.line2cardNumber + cardTimes > DTZRoomModel.firstLineLimit && DTZRoomModel.is3FuPai()) {
                //cc.log("该卡牌已经超出");
                return true;
            } else {
                return false;
    ...
    updatePlayersStates:function(dtzRoom , messageStr){
        ...
        for(var curIndex = 0 ; curIndex < messageStr.length ; curIndex ++){
            ...
            if(playerTeam == 0){
                ...
                if(playerTeam == 1){
                    teamDesc = "A组";
                    teamNode.loadTexture("res/res_dtz/dtzRoom/a.png");
                }else{
                    teamDesc = "B组";
                    teamNode.loadTexture("res/res_dtz/dtzRoom/b.png");
                }
            }
    ...
    showIcon:function(sprite,iconNode,iconUrl){
        if(iconUrl){
            sprite.x = sprite.y = 0;
            try{
                var sten = new cc.Sprite("res/res_gameCom/default_m.png");
                sten.setScale(0.8);
                var clipnode = new cc.ClippingNode();
                clipnode.attr({stencil: sten, anchorX: 0.5, anchorY: 0.5, x: 65, y: 105, alphaThreshold: 0.8});
    ...
    fixSort:function(dtzRoom , showAction){
        ...
        var centerX = (winSize.width - cardSize.width) / 2;
        ...
        for (var i = 0; i < cards.length; i++) {
            ...
            var realY = DTZRoomModel.initCardYLine2;
            ...
            if(showLine == 1){
                ...
                realY = DTZRoomModel.initCardYLine1;
    ...
    lableAction:function(x , y){
        ...
        var tchangeColor = cc.sequence(cc.tintTo(0.25 , 255 , 0 , 0) , cc.tintTo(0.25 , 113 , 210 , 146) ,
            cc.tintTo(0.25 , 255 , 0 , 0) , cc.tintTo(0.25 , 106 , 255 , 66));
