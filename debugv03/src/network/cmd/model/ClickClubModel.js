...
var ClickClubModel = {
    ...
    clickClubName:"",           //俱乐部名字
    clickClubRole:90000,            //我在当前俱乐部的身份 0擂主 1副擂主 2普通成员
    clickClubIsOpenLeaderPay:0, //当前俱乐部是否开启擂主支付
    ...
    clickClubIsOpenCredit:0, //当前俱乐部是否开启"擂台房"
    clickClubBagModeId:0,              //当前选择的包厢的modeId
    clickClubAllotMode:1, //当前俱乐部擂台房的分成方式1大赢家分成，2参与分成
    promoterLevel:0,            //门主等级
    payBindId:"",//俱乐部擂主的邀请码
    content:"",//俱乐部公告内容
    ...
    * 获取当前俱乐部ID
    ...
    getClubRoleName:function(_role,_level){
        ...
        var allPartnerArr = [
            {name:"馆主",    promoterLevel:2},
            {name:"门主1",    promoterLevel:3},
            {name:"门主2",    promoterLevel:4},
            {name:"门主2",    promoterLevel:5},
            {name:"门主2",    promoterLevel:6},
            {name:"门主2",    promoterLevel:7},
            {name:"门主2",    promoterLevel:8},
            {name:"门主2",    promoterLevel:9},
            {name:"门主2",    promoterLevel:10},
        ];
        var name = "";
