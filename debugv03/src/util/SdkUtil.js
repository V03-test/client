...
var SdkUtil = {
	...
	COMMON_HTTP_URL:"http://login.lemaitrading.cn",
	ENCRYP_KEY_HTTP:"xw2qRjtbesoMPcd8",
	ENCRYP_KEY_AES:"dKPVJ60PJS8mlONb",
	ENCRYP_KEY_URL:"KbzG2kNBuQe8RrMW",
	isIosAudit:0,
	payType:"",
	fcNewParams:null,
		...
		if(ShareDailyModel.isFromShareDaily){
			...
			if(json.code==0){
				...
				if(!ActivityModel.isBrokeShare && !ActivityModel.isHomeLayerShare ){
					Network.loginReqNew(509,{action:2},function(data){
