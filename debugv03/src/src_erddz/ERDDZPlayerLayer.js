...
var ERDDZPlayerNode = cc.Node.extend({
    ...
    initNode:function(){
        var playerBg = new cc.Sprite("res/res_erddz/playerBg.png");
        ...
        playerBg.setPosition(-headKuang.width / 2 - 20,0);
        ...
        this.label_name = UICtor.cLabel("玩家的名字",30);
        ...
        this.label_score = UICtor.cLabel("123",30);
        this.label_score.setColor(cc.color("#fffd860"));
        this.addChild(this.label_score);

        this.label_sai = UICtor.cLabel("赛:12345678",30);
        this.label_sai.setColor(cc.color("#fffd860"));
        this.addChild(this.label_sai);

        this.image_coin = new cc.Sprite("res/res_erddz/img_jinbi.png");
        this.image_coin.opacity = 0;
        this.addChild(this.image_coin);

        this.label_coin = UICtor.cLabel("12345678",30);
        this.label_coin.setColor(cc.color("#fffd860"));
    ...
    setPosWithIdx:function(idx){
        ...
        this.tipSpr.setPosition(-25,40);
        this.icon_tuoguan.setPosition(55,55);

        var localX = 160;
        this.label_name.setAnchorPoint(0.5,0.5);
        this.label_name.setPosition(localX,40);
        this.label_score.setAnchorPoint(0.5,0.5);
        this.label_score.setPosition(localX,0);
        this.label_sai.setAnchorPoint(0.5,0.5);
        this.label_sai.setPosition(localX,-40);
        //this.label_coin.setAnchorPoint(0.5,0.5);
        //this.label_coin.setPosition(localX,0);
