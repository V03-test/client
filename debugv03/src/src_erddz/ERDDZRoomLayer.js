...
var ERDDZRoomLayer = ERDDZBaseRoomLayer.extend({
    ...
    initLayer:function(){
        ...
        this.label_rule_tip.setTextHorizontalAlignment(cc.TEXT_ALIGNMENT_LEFT);
        this.label_rule_tip.setOpacity(255);
        this.label_rule_tip.setAnchorPoint(0,1);
        this.label_rule_tip.setColor(cc.color("#ffffff"));
        this.label_rule_tip.setPosition(cc.winSize.width / 2 - 950,cc.winSize.height/2 + 295);
        this.addChild(this.label_rule_tip);

        var diCardBg = new cc.Sprite("res/res_erddz/diCardBg.png");
        diCardBg.setAnchorPoint(0.5,0.5);
        diCardBg.setPosition(220,cc.winSize.height - 155);
        this.addChild(diCardBg);
        this.diCardBg = diCardBg;

        var label_txt1 = UICtor.cLabel("倍数:",32);
        label_txt1.setPosition(diCardBg.width/2 + 90,diCardBg.height/2 + 55);
        diCardBg.addChild(label_txt1);

        var label_txt2 = UICtor.cLabel("让牌:",32);
        label_txt2.setPosition(diCardBg.width/2 + 90,diCardBg.height/2 - 5);
        diCardBg.addChild(label_txt2);

        this.label_beishu = UICtor.cLabel("0",32);
        this.label_beishu.setPosition(label_txt1.x + 45,label_txt1.y);
        this.label_beishu.setColor(cc.color("#ffd860"));
        this.label_beishu.setAnchorPoint(0,0.5);
        diCardBg.addChild(this.label_beishu);

        this.label_rangpai = UICtor.cLabel("0",32);
        this.label_rangpai.setPosition(label_txt2.x + 45,label_txt2.y);
        this.label_rangpai.setColor(cc.color("#ffd860"));
        this.label_rangpai.setAnchorPoint(0,0.5);
        diCardBg.addChild(this.label_rangpai);

        this.tip_bg = new cc.Sprite("res/res_erddz/rangPaiBg.png");
        this.tip_bg.setPosition(cc.winSize.width/2,cc.winSize.height/2 - 10);
        this.tip_bg.setVisible(false);
        this.addChild(this.tip_bg);

        this.label_tip = UICtor.cLabel("",42);
        this.label_tip.setPosition(this.tip_bg.width/2,this.tip_bg.height/2);
        this.label_tip.setColor(cc.color.WHITE);
    ...
    addBottomBtn:function(){
        ...
        this.btn_yuyin.setPosition(cc.winSize.width - 100,620);
    ...
    addRoomBtn:function(){
        ...
        this.btn_tuichu.visible = !ERDDZRoomModel.replay;
    ...
    handleTableData:function(type,data){
        ...
        if(type == ERDDZTabelType.CreateTable){
            ...
            data.diCards = ERDDZRoomModel.diCards || [];
    ...
    showDiPai:function(type){
        ...
        for(var i = 0;i<cards.length;++i){
            ...
            //this.addChild(card);
            card.setPosition(50 + i*86,this.diCardBg.height/2 + 22);
            this.diCardBg.addChild(card);
            if(type == 2){
                card.showFanPaiAni();
            }
            if(BaseXiPaiModel.isNeedXiPai){
        ...
        if(str && ERDDZRoomModel.intParams[9] == 1){
            var typeBg = new cc.Sprite("res/res_erddz/beishuDi.png");
            //typeBg.setPosition(cc.winSize.width - 230,cc.winSize.height/2 + 150);
            //this.addChild(typeBg);
            typeBg.setPosition(this.diCardBg.width/2,22.5);
            this.diCardBg.addChild(typeBg);
