...
var ERDDZOptBtnLayer = cc.Layer.extend({
    ...
    showNoDaTip:function(isShow){
        if(isShow){
            if(!this.nodaSpr){
                this.nodaSpr = new cc.Sprite("res/res_erddz/rangPaiBg.png");
                this.nodaSpr.setPosition(cc.winSize.width/2,320);
    ...
    initLayer:function(){
        ...
        this.btn_buyao.setPosition(-400,this.localY);
        ...
        this.btn_tishi.setPosition(50,this.localY);
        ...
        this.btn_chupai.setPosition(400,this.localY);
        ...
        this.clock_num = UICtor.cLabel("60",44);
        this.clock_num.setColor(cc.color("#9f3800"));
    ...
    showRangBtn:function(isShow){
        ...
        for(var i = 0;i<=num;++i){
            ...
            btn.setPosition(startX,this.localY);
            btn.setTag(i);
    ...
    setClockState:function(){
        ...
        if(isShow){
            ...
            var pos = cc.p(cc.winSize.width/2 + 680,this.contentNode.y + this.localY);
            if(this.showType == 2){
