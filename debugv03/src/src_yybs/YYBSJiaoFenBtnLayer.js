...
var YYBSJiaoFenBtnLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        for(var i = 0;i<typeArr.length;++i){
            var btn = new ccui.Button("res/res_yybs/"+ imgArr[i] + ".png","res/res_yybs/"+ imgArr[i] + ".png","res/res_yybs/"+ imgArr[i] + "1.png");
...
var YYBSFanZhuLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        //res/res_ui/qyq/common/commonKuang/tanchuangBg
        this.layerBg = new cc.Sprite("res/res_ui/qyq/tiren/bg.png");
        ...
        this.btn_cancel.setPosition(this.layerBg.width/2,120);
    ...
    addCurCard:function(data){
        for(var i = 0;i<data.length;++i){
            ...
            card.setPosition(90 + i*card.width,this.layerBg.height - 140);
