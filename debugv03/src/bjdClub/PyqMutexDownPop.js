...
var PyqMutexDownPop = BasePopup.extend({
    ...
    getMutexData:function(_optType,_userId){
        ...
        var self = this;
        NetworkJT.loginReqNew("groupActionNew", "loadGroupRejectPool",params , function (data) {
            if (data) {
    ...
    updateMutexData:function(_optType){
        ...
        var self = this;
        NetworkJT.loginReqNew("groupActionNew", "updateGroupRejectPool",params , function (data) {
            if (data) {
