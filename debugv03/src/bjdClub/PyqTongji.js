...
var PyqTongji = BasePopup.extend({
    ...
    updateSortBtnState:function(){
        ...
        for(var i = 0;i<btnArr.length;++i){
            ...
            if(this.curSortBtn == btnArr[i]){
                var img = "res/res_ui/qyq/common/commonButton/jts1.png";
                if(!this.isUp)img = "res/res_ui/qyq/common/commonButton/jtx1.png";
                if(this.curSortBtn == btnArr[i]){
                    img = "res/res_ui/qyq/common/commonButton/jts2.png";
                    if(!this.isUp)img = "res/res_ui/qyq/common/commonButton/jtx2.png";
                }
    ...
    getRankData:function(page){
        ...
        NetworkJT.loginReqNew(200, {startDate:this.label_begin.getString(), endDate : this.label_end.getString(),orderRule:this.isUp?"desc":"asc",
