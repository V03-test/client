...
var PyqSet = BasePopup.extend({
    ...
    selfRender:function(){
        ...
        this.inputBox1.setPlaceholderFontColor(cc.color("#2155b5"));
        ...
        this.inputBox2.setPlaceholderFontColor(cc.color("#2155b5"));
        ...
        this.box_kjzs.setPlaceholderFontColor(cc.color("#2155b5"));
        ...
        this.input_countBox.setPlaceholderFontColor(cc.color("#2155b5"));
        ...
        var tipBtn = this.getWidget("Button_tip");
        ...
        this.btn_qztc = this.getWidget("btn_jqztc");
        UITools.addClickEvent(this.btn_qztc,this,this.onClickQztc);

        var btn = this.getWidget("btn_hcmd");
    ...
    onClickQztc:function(){
        ...
        if(ClickClubModel.getQunZhuTiChu()){
            ...
            desc = "开启后仅擂主和副擂主可踢出成员";
            param = 1;
        }

        AlertPop.show(desc,function(){
            NetworkJT.loginReqNew(433, {keyId:ClickClubModel.getCurClubKeyId(),groupId:ClickClubModel.getCurClubId(),
    ...
    onClickXxzdsf:function(){
        ...
        if(!ClickClubModel.isClubCreater()){
            FloatLabelUtil.comText("擂主才可修改");
            return;
        }

        AlertPop.show(desc,function(){
            NetworkJT.loginReqNew(433, {
                keyId:ClickClubModel.getCurClubKeyId(),groupId:ClickClubModel.getCurClubId(),
    ...
    updateSelectCountBtn:function(){
        ...
        var index = num == 0 ? 0 : 1;
        var resList = ["res/res_ui/qyq/common/commonButton/checkBox1.png","res/res_ui/qyq/common/commonButton/checkBox2.png"];
    ...
    onClickDismissCount:function(num,sender){
        ...
        if(!ClickClubModel.isClubCreaterOrLeader()){
            FloatLabelUtil.comText("擂主和副擂主才可修改");
            return;
        }

        NetworkJT.loginReqNew(309, {keyId:ClickClubModel.getCurClubKeyId() ,
    ...
    onClickForbidInvite:function(){
        ...
        var self = this;
        var state = "0";
        cc.log("ClickClubModel.getIsForbidInvite()==",ClickClubModel.getIsForbidInvite())
    ...
    onClickRefuseInvite:function(){
        ...
        AlertPop.show(desc,function(){
            NetworkJT.loginReqNew(308, {gid:ClickClubModel.getCurClubId() ,uid:PlayerModel.userId , status:state}, function (data) {
                if (data) {
    ...
    onClickJiesan:function(){
        ...
        AlertPop.show(tipStr,function(){
            NetworkJT.loginReqNew(312, params, function (data) {
                if (data) {
                    if(data.count != 0){
    ...
    onClickTuichu:function(){
        ...
        if(ClickClubModel.getCurClubRole() == 0){
            AlertPop.show("解散亲友圈后无法恢复，确定吗？",function(){
                NetworkJT.loginReqNew("groupAction", "dissGroup", {keyId:ClickClubModel.getCurClubKeyId() ,userId:PlayerModel.userId}, function (data) {
                    if (data) {
    ...
    onChangePrivate:function(){
        ...
        AlertPop.show(desc,function(){
            NetworkJT.loginReqNew(433, {
                privateRoom:isAllow,optType:12,groupId:ClickClubModel.getCurClubId(),
    ...
    updateBtnState:function(type){
        ...
        if(type == 3 || type == 0){
            var resfile = "res/res_ui/qyq/shezhi/allowInvite.png";
            if(ClickClubModel.getIsRefuseInvite()){
                resfile = "res/res_ui/qyq/shezhi/stopInvite.png";
            }
        ...
        if(type == 4 || type == 0){
            var resfile = "res/res_ui/qyq/shezhi/allowChat.png";
            if(ClickClubModel.getIsBanVoiceAndProps()){
                resfile = "res/res_ui/qyq/shezhi/stopChat.png";
            }
        ...
        if(type == 5 || type == 0){
            var resfile = "res/res_ui/qyq/common/commonButton/checkBox2.png";
            if(ClickClubModel.getIsNegativeCredit()){
                resfile = "res/res_ui/qyq/common/commonButton/checkBox1.png";
            }
        ...
        if(type == 7 || type == 0){
            var resfile = "res/res_ui/qyq/shezhi/showNullTable.png";
            if(ClickClubModel.getTableOrder() == 1){
                resfile = "res/res_ui/qyq/shezhi/showTable.png";
            }
        ...
        if(type == 8 || type == 0){
            var resfile = "res/res_ui/qyq/shezhi/allowClubInvite.png";
            if(ClickClubModel.getIsForbidInvite()){
                resfile = "res/res_ui/qyq/shezhi/stopClubInvite.png";
            }
        ...
        if(type == 9 || type == 0){
            var resfile = "res/res_ui/qyq/common/commonButton/checkBox2.png";
            if(ClickClubModel.getIsAutoLock()){
                resfile = "res/res_ui/qyq/common/commonButton/checkBox1.png";
            }
        ...
        if(type == 10 || type == 0){
            ...
            this.btn_qztc.loadTextureNormal(resfile,ccui.Widget.LOCAL_TEXTURE);
            // this.btn_qztc.loadTexturePressed(resfile,ccui.Widget.LOCAL_TEXTURE);
        }
        if(type == 12 || type == 0){
            var resfile = "res/res_ui/qyq/common/commonButton/checkBox2.png";
            if(ClickClubModel.getIsPrivateRoom()){
    ...
    onClickChangeGg:function(){
        ...
        NetworkJT.loginReqNew(433, {
            content:content,optType:1,groupId:ClickClubModel.getCurClubId(),
    ...
    onClickChangeName:function(){
        ...
        NetworkJT.loginReqNew(433, {
            groupName:name,optType:2,groupId:ClickClubModel.getCurClubId(),
            userId:PlayerModel.userId  ,subId:0,sessCode:PlayerModel.sessCode}, function (data) {
            if (data) {
                cc.log("updateGroupInfo::"+JSON.stringify(data));
                FloatLabelUtil.comText("修改成功");
    ...
    onClickForbit:function(obj){
        ...
        var self = this;
        NetworkJT.loginReqNew(433, params, function (data) {
            if (data) {
                //ClickClubModel.updateDismissCount(param);
                FloatLabelUtil.comText("修改成功");
...
var PyqPifuPop = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        var bg = new cc.Sprite("res/res_ui/qyq/common/commonKuang/tanchuangBg.png");
        bg.setPosition(cc.winSize.width/2,cc.winSize.height/2);
        this.addChild(bg);

        var title = new cc.Sprite("res/res_ui/qyq/pifu/pifu.png");
        ...
        btn_close.setPosition(bg.width - 65,bg.height - 75);
