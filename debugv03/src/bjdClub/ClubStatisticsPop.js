...
var ClubStatisticsPop = BasePopup.extend({
    ...
    onClickSwitch: function (obj) {
        ...
        var imgPath = "res/res_ui/qyq/common/commonBg/bg.jpg";
        if(temp == 2){
            imgPath = "res/res_ui/qyq/common/commonBg/bgs.jpg";
        }
        this.getWidget("layerBg").loadTexture(imgPath);
    ...
    getRankData: function (page, rankField, rankType) {
        ...
        //   rankField 1输赢信用分，2奖赏分，3奖赏次数，4总局数，5大赢家数，6总消耗
        //   rankType  1降序，2升序
        //   pageNo
        //   pageSize
        ...
        //   数据：
        //selfWinCredit 输赢信用分
        //   selfCommissionCredit 奖赏分
        //   selfCommissionCount 奖赏次数
        //   selfZjsCount 总局数
        //   selfDyjCount 大赢家数
        //   selfTotalPay 总消耗
        ...
        NetworkJT.loginReqNew(423, params, function (data) {
            sy.scene.hideLoading();
            if (data) {
    ...
    getClubCommissionLog: function () {
        ...
        NetworkJT.loginReqNew(402, params, function (data) {
            sy.scene.hideLoading();
            if (data && data.code == 0 && data.message) {
