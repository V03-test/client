...
var ClubBagCell = ccui.Widget.extend({
    ctor:function(data,root,idx){
        ...
        this.setContentSize(1774, 210);

        var Panel_16=this.Panel_16= UICtor.cPanel(cc.size(1774,210),cc.color(150,200,255),0);
        ...
        Button_roombg.setPosition(887,105);
        this.Button_roombg.setContentSize(1774, 210);
        ...
        var openBtn=this.openBtn= UICtor.cBtn("res/res_ui/qyq/wanfa/guanbi.png");
        openBtn.setPosition(cc.p(300+Button_roombg.getAnchorPointInPoints().x, 0+Button_roombg.getAnchorPointInPoints().y));
        Button_roombg.addChild(openBtn);

        this.delBtn= UICtor.cBtn("res/res_ui/qyq/wanfa/delete.png");
        this.delBtn.setPosition(cc.p(530+Button_roombg.getAnchorPointInPoints().x, 0+Button_roombg.getAnchorPointInPoints().y));
        Button_roombg.addChild(this.delBtn);

        var changeBtn=this.changeBtn= UICtor.cBtn("res/res_ui/qyq/wanfa/xg.png");
        changeBtn.setPosition(cc.p(760+Button_roombg.getAnchorPointInPoints().x, 0+Button_roombg.getAnchorPointInPoints().y));
    ...
    showSwitch: function(){
        if (this.groupState == 1){
            this.openBtn.loadTextureNormal("res/res_ui/qyq/wanfa/guanbi.png",ccui.Widget.LOCAL_TEXTURE);
        }else{
            this.openBtn.loadTextureNormal("res/res_ui/qyq/wanfa/kaiqi.png",ccui.Widget.LOCAL_TEXTURE);
        }
    },
    ...
    onDeleteBag:function(obj){
        ...
        var desc = "删除包厢，确认删除吗？";
        AlertPop.show(desc,function() {
            NetworkJT.loginReqNew(301, {userId:PlayerModel.userId,keyId:that.bagKeyID,
...
var ClubBagManagePop = BasePopup.extend({
    ...
    selfRender:function(){
        ...
        if(ClickClubModel.isClubCreaterOrLeader()){
            Button_add.x -= 375;
            var btn = ccui.Button("res/res_ui/qyq/wanfa/wfbxpxBtn.png");
            btn.setPosition(Button_add.x + 750,Button_add.y);
