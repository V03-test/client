...
var PyqRecordPop = BasePopup.extend({
    ...
    selfRender:function(){
        ...
        this.inputRoomIdBox.setPlaceholderFontColor(cc.color("#2155b5"));
        ...
        this.inputUserIdBox.setPlaceholderFontColor(cc.color("#2155b5"));
    ...
    onClickIsSelf:function(){
        ...
        var res = this.isSelf ? "res/res_ui/qyq/common/commonButton/checkBox1.png" : "res/res_ui/qyq/common/commonButton/checkBox2.png";
    ...
    onClickClubSearchRoom:function(){
        ...
        //if(role != 0 && role != 1){
        //    FloatLabelUtil.comText("只有副擂主以上权限才能查询");
        //    return;
        //}
    ...
    getLogWithCode:function(code){
        Network.loginReqNew(503,{logId:code, userId:PlayerModel.userId}, function(data){
            if(data){
    ...
    getClubRecordData:function(page,roomId,userId){
        ...
        NetworkJT.loginReqNew(420, {groupId:ClickClubModel.getCurClubId(),
            //queryDate:1,  //当前日期
            pageNo:page,  //当前页数
    ...
    handleClubDetailData:function(data){
        ...
        if(data.playLog[0].generalExt){
            ...
            if(msgArr[0] == 1){
                ...
                creditMsg += ("  奖赏初始:"+zscsScore);
                creditMsg += ("\n奖赏分数:"+zsfsScore);
                creditMsg += ("  擂台底分:"+bsdfScore);
                creditMsg += ("  擂主保底:"+qzbdScore);
    ...
    playHuifang:function(hfData){
        ...
        if(GameTypeManager.isMJ(hfData.playType)){
            ...
            layer.initData();
            return;
        }else if(GameTypeManager.isZP(hfData.playType)){
            PHZRePlayModel.init(hfData);
            var LayerName = LayerFactory.PHZ_REPLAY_MORE;
            if(PHZRePlayModel.renshu == 3) {
                LayerName = LayerFactory.PHZ_REPLAY;
            } else if(PHZRePlayModel.renshu == 2){
...
var ShowClubConfigPop = cc.Layer.extend({
    ...
    showConfig:function(){
        this.layerBg = new cc.Scale9Sprite("res/res_ui/qyq/common/commonKuang/xiaoxiDi.png");
...
//        var btn_close = new ccui.Button("res/ui/bjdmj/popup/x.png");
        var btn_close = new ccui.Button("res/res_ui/qyq/common/commonButton/closeBtn.png");
        ...
        var txtArr = ["奖赏人","获赠人","奖赏分"];

        for(var i = 0;i<txtArr.length;++i){
            var label = UICtor.cLabel(txtArr[i],40);
            label.setColor(cc.color("#90371f"));
            label.setPosition(120 + i*360,bg.height - 90);
            bg.addChild(label);
        }
    ...
    getZsxqData:function(tableNo){
        var self = this;
        NetworkJT.loginReqNew(411, {groupId:ClickClubModel.getCurClubId(),
...
var GiveDetailItem = cc.Node.extend({
    ...
    initNode:function(){
        var bg = new cc.Scale9Sprite("res/res_ui/qyq/common/commonKuang/xinxiTiao.png");
        bg.setContentSize(900,120);
        bg.setPosition(this.width/2,this.height/2);
        this.addChild(bg);

        var img_head1 = new cc.Sprite("res/res_ui/homeLayer/head_kuang.png");
        ...
        label_name1.setColor(cc.color("#90371f"));
        ...
        label_name2.setColor(cc.color("#90371f"));
        ...
        label_id2.setColor(cc.color("#cd3d17"));
        ...
        label_score.setColor(cc.color("#cd3d17"));
