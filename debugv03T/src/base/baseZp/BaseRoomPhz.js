 ...
 */
var BaseRoomPhz = BaseRoom.extend({ //BaseLayer BaseRoom
    layouts:{},
    tag_btn_chi:601,
    tag_btn_liu:602,
    tag_btn_other:501,
    ...
    selfRender:function(){
        ...
        if(PHZRoomModel.wanfa==GameTypeEunmZP.XTPHZ || PHZRoomModel.wanfa==GameTypeEunmZP.XXPHZ || PHZRoomModel.wanfa==GameTypeEunmZP.XXGHZ
            ...
            ||  PHZRoomModel.wanfa==GameTypeEunmZP.AHPHZ ||  PHZRoomModel.wanfa==GameTypeEunmZP.WCPHZ
        ...
        this.battery = new cc.Sprite("res/res_phz/pp/tx_battery_full.png");//this.getWidget("battery");//电量
        this.battery.anchorX = 0;
        this.battery.x = 0;
        this.battery.y = 8.3;
        this.getWidget("batteryBg").addChild(this.battery);
        ...
        if(!SdkUtil.isReview()){
            ...
            this.progCycle = new cc.ProgressTimer(new cc.Sprite("res/res_dtz/images/img_audio_2.png"));
            ...
            var recordBtn = this.recordBtn = new RecordAudioButton(this.yuyin,this.progCycle,"res/res_phz/pp/voiceNormal.png","res/res_phz/pp/voiceNormal.png");
    ...
    showWaitSelectPiao:function(isShow){
        if(isShow){
            if(!this.waitPiaoImg){
                this.waitPiaoImg = new cc.Sprite("res/res_mj/csmjRoom/word_piaofen.png");
    ...
    //开局动画
    fingerAni:function(){
        var tishi = new cc.Sprite("res/ui/common/img_shouzi1.png");
        tishi.x = 115;
        tishi.y = 175;
        tishi.scale = 0.6;
        this.Panel_shouzhi.addChild(tishi, 1);

        var jiantou = new cc.Sprite("res/ui/common/img_shouzi3.png");
        jiantou.x = 100;
        jiantou.y = 100;
        jiantou.scale = 0.6;
        ...
        var shouzi = new cc.Sprite("res/ui/common/img_shouzi2.png");
        shouzi.x = 62;
        shouzi.y = 25;
        shouzi.scale = 0.6;
...
/*        var mc = new ChatPop("res/phzChat.json");
        ...
        for(var i=0;i<players.length;i++){
            ...
            if(!isContinue){
                ...
                if(PHZRoomModel.wanfa!=36 && PHZRoomModel.renshu==4 && p.ext[3]==p.seat
                    && PHZRoomModel.wanfa != GameTypeEunmZP.LDS&& PHZRoomModel.wanfa != GameTypeEunmZP.JHSWZ && PHZRoomModel.wanfa != GameTypeEunmZP.YZCHZ){
        ...
        if (PHZRoomModel.is4Ren()) {
            ...
            if (paiDun == 0 && remain > 0) {
                for (var i=0;i<remain;i++) {
                    var dun = new cc.Sprite("res/res_phz/pp/card.png");
    ...
    updateRoomInfo:function(){
        if(this.label_payType){
            ...
            if(PHZRoomModel.getCostFangShi() == 1){
                ...
                this.label_payType.setString("擂主支付");
            }
        }
    ...
    startGame:function(event){
        ...
        || GameTypeEunmZP.XTPHZ == PHZRoomModel.wanfa || GameTypeEunmZP.AHPHZ == PHZRoomModel.wanfa || GameTypeEunmZP.WCPHZ == PHZRoomModel.wanfa
    ...
    refreshButton:function(selfAct){
        ...
        if(selfAct.length>0){
            ...
            var btnDatas = [];
            var textureMap = {
                0:{t:"res/res_phz/hu.png",v:1},2:{t:"res/res_phz/wai.png",v:3},3:{t:"res/res_phz/liu.png",v:4},1:{t:"res/res_phz/peng.png",v:2},
                4:{t:"res/res_phz/chi.png",v:6},5:{t:"res/res_phz/pao.png",v:7}};
            ...
            if(btnDatas.length>0 && isShowBtn){
                ...
                isShowGuo && btnDatas.push({t:"res/res_phz/guo.png",v:5});
                var w = 150;//118
                var g = 20;
    ...
    onLetOutPai:function(message){
        ...
        if(PHZRoomModel.wanfa == GameTypeEunmZP.LDS || PHZRoomModel.wanfa == GameTypeEunmZP.YZCHZ || PHZRoomModel.wanfa == GameTypeEunmZP.JHSWZ){//落地扫王闯之类的胡牌操作特殊处理下
    ...
    onInvite:function(){
        ...
        if(PHZRoomModel.wanfa==GameTypeEunmZP.SYZP){
            ...
            obj.description = clubStr + csvhelper.strFormat("望城跑胡子，{0}人，{1}", PHZRoomModel.renshu, wanfaDesc);
        }
        obj.shareType=1;
        //SdkUtil.sdkFeed(obj);
        ShareDTPop.show(obj);
    ...
    updateBgColor:function(){
        var bgTexture = "res/res_phz/pp/room_bg1.jpg";
        var gameTypeUrl = "";
        var ldfpf_qihuType ="";
        ...
        var wanfaUrl = "";
        if (PHZRoomModel.wanfa == GameTypeEunmZP.SYBP){
            gameTypeUrl = "res/res_phz/pp/gametype1.png";
            this.Image_phzdetail.visible = true;
            wanfaUrl = "res/res_phz/pp/wanfa1_1.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.SYZP){
            gameTypeUrl = "res/res_phz/pp/gametype1_1.png";
            this.Image_phzdetail.visible = true;
            wanfaUrl = "res/res_phz/pp/wanfa2_1.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.LYZP){
            gameTypeUrl = "res/res_phz/pp/gametype1_4.png";
            this.Image_phzdetail.visible = true;
            wanfaUrl = "res/res_phz/phzRoom/10hqh_1.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.LYZP){
            gameTypeUrl = "res/res_phz/pp/gametype1_4.png";
            this.Image_phzdetail.visible = true;
            wanfaUrl = "res/res_phz/phzRoom/10hqh_1.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.WHZ){
            gameTypeUrl = "res/res_phz/pp/gametype1_5.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.HYSHK){
            gameTypeUrl = "res/res_phz/pp/gametype1_hyshk.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.LDS){
            gameTypeUrl = "res/res_phz/pp/gametype1_lds.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.XXGHZ){
            gameTypeUrl = "res/res_phz/pp/gametype1_xxghz.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.XXPHZ){
            gameTypeUrl = "res/res_phz/pp/gametype1_xxphz.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.AHPHZ){
            gameTypeUrl = "res/res_phz/pp/gametype1_ahphz.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.GLZP){
            gameTypeUrl = "res/res_phz/pp/gametype1_glzp.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.NXPHZ){
            gameTypeUrl = "res/res_phz/pp/gametype1_nxphz.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.XTPHZ){
            gameTypeUrl = "res/res_phz/pp/gametype1_xtphz.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.WCPHZ){
            gameTypeUrl = "res/res_phz/pp/gametype1_wcphz.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.JHSWZ){
            gameTypeUrl = "res/res_phz/pp/gametype1_jhswz.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.YZCHZ){
            this.Image_manbai.visible = true;
            this.Image_qihu.visible = true;
            gameTypeUrl = "res/res_phz/pp/gametype1_yzchz.png";
            var huxi = PHZRoomModel.intParams[14] || 15;
            ldfpf_qihuType = "res/res_phz/phzRoom/" + huxi + "_hqh_1.png";
            ...
            ldfpf_manbaiType = "res/res_phz/phzRoom/" + fengding + "_1.png";

        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.HYLHQ){
            gameTypeUrl = "res/res_phz/pp/gametype1_7.png";
            wanfaUrl = "res/res_phz/phzRoom/"+PHZRoomModel.intParams[21]+"hqh_1.png";
        }else{
            this.Image_phzdetail.visible = false;
            this.Image_manbai.visible = true;
            this.Image_qihu.visible = true;
            if (PHZRoomModel.wanfa == GameTypeEunmZP.LDFPF){
                gameTypeUrl = "res/res_phz/pp/gametype1_2.png";
                ldfpf_qihuType = "res/res_phz/phzRoom/" + PHZRoomModel.intParams[13] + "hqh_1.png";
                ldfpf_manbaiType = "res/res_phz/phzRoom/mbjs_1.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.CZZP){
                gameTypeUrl = "res/res_phz/pp/gametype1_3.png";
                var huxi = PHZRoomModel.intParams[11] == 2?6:PHZRoomModel.intParams[11] == 3?3:9;
                ldfpf_qihuType = "res/res_phz/phzRoom/" + huxi + "xqh_1.png";
                var huxizhuanhuan = PHZRoomModel.intParams[10] == 2?1:3;
                ldfpf_manbaiType = "res/res_phz/phzRoom/"+ huxizhuanhuan + "xyt_1.png";
            }
        }
        // var wanfaUrl = PHZRoomModel.wanfa == GameTypeEunmZP.SYBP ? "res/res_phz/pp/wanfa1_1.png" : "res/res_phz/pp/wanfa2_1.png";
        if (PHZSetModel.zmbj == 1){
            this.roomName_label.setColor(cc.color(214,203,173));
        }else if (PHZSetModel.zmbj == 2 || PHZSetModel.zmbj == 5){
            if (PHZRoomModel.wanfa == GameTypeEunmZP.SYBP){
                gameTypeUrl = "res/res_phz/pp/gametype2.png";
                wanfaUrl = "res/res_phz/pp/wanfa1_2.png"
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.SYZP){
                gameTypeUrl = "res/res_phz/pp/gametype2_1.png";
                wanfaUrl = "res/res_phz/pp/wanfa2_2.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.LDFPF){
                gameTypeUrl = "res/res_phz/pp/gametype2_2.png";
                ldfpf_qihuType = "res/res_phz/phzRoom/" + PHZRoomModel.intParams[13] + "hqh_2.png";
                ldfpf_manbaiType = "res/res_phz/phzRoom/mbjs_2.png"
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.CZZP){
                gameTypeUrl = "res/res_phz/pp/gametype2_3.png";
                var huxi = PHZRoomModel.intParams[11] == 2?6:PHZRoomModel.intParams[11] == 3?3:9;
                ldfpf_qihuType = "res/res_phz/phzRoom/" + huxi + "xqh_2.png";
                var huxizhuanhuan = PHZRoomModel.intParams[10] == 2?1:3;
                ldfpf_manbaiType = "res/res_phz/phzRoom/"+ huxizhuanhuan + "xyt_2.png"
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.LYZP){
                gameTypeUrl = "res/res_phz/pp/gametype2_4.png";
                wanfaUrl = "res/res_phz/phzRoom/10hqh_2.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.WHZ){
                gameTypeUrl = "res/res_phz/pp/gametype2_5.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.HYSHK){
                gameTypeUrl = "res/res_phz/pp/gametype2_hyshk.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.LDS){
                gameTypeUrl = "res/res_phz/pp/gametype2_lds.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.XXGHZ){
                gameTypeUrl = "res/res_phz/pp/gametype2_xxghz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.AHPHZ){
                gameTypeUrl = "res/res_phz/pp/gametype2_ahphz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.GLZP){
                gameTypeUrl = "res/res_phz/pp/gametype2_glzp.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.NXPHZ){
                gameTypeUrl = "res/res_phz/pp/gametype2_nxphz.png";
            } else if (PHZRoomModel.wanfa == GameTypeEunmZP.XXPHZ){
                gameTypeUrl = "res/res_phz/pp/gametype2_xxphz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.XTPHZ){
                gameTypeUrl = "res/res_phz/pp/gametype2_xtphz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.WCPHZ){
                gameTypeUrl = "res/res_phz/pp/gametype2_wcphz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.JHSWZ){
                gameTypeUrl = "res/res_phz/pp/gametype2_jhswz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.YZCHZ){
                this.Image_manbai.visible = true;
                this.Image_qihu.visible = true;

                gameTypeUrl = "res/res_phz/pp/gametype2_yzchz.png";
                var huxi = PHZRoomModel.intParams[14] || 15;
                ldfpf_qihuType = "res/res_phz/phzRoom/" + huxi + "_hqh_2.png";

                var fengding = "bfd";
                if(PHZRoomModel.intParams[8] == 1)fengding = "300fd";
                if(PHZRoomModel.intParams[8] == 2)fengding = "600fd";
                if(PHZRoomModel.intParams[8] == 3)fengding = "800fd";
                ldfpf_manbaiType = "res/res_phz/phzRoom/" + fengding + "_2.png";

            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.HYLHQ){
                gameTypeUrl = "res/res_phz/pp/gametype2_7.png";
                cc.log("PHZRoomModel.intParams[21] =",PHZRoomModel.intParams[21])
                wanfaUrl = "res/res_phz/phzRoom/"+PHZRoomModel.intParams[21]+"hqh_2.png";
            }
            // wanfaUrl = PHZRoomModel.wanfa == GameTypeEunmZP.SYBP ? "res/res_phz/pp/wanfa1_2.png" : "res/res_phz/pp/wanfa2_2.png";
            bgTexture = "res/res_phz/pp/room_bg2.jpg";
            if (PHZSetModel.zmbj == 5){
                bgTexture = "res/res_phz/pp/room_bg5.jpg";
            }
            this.roomName_label.setColor(cc.color(204,204,204));
        }else if (PHZSetModel.zmbj == 3){
            if (PHZRoomModel.wanfa == GameTypeEunmZP.SYBP){
                gameTypeUrl = "res/res_phz/pp/gametype3.png";
                wanfaUrl = "res/res_phz/pp/wanfa1_3.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.SYZP){
                gameTypeUrl = "res/res_phz/pp/gametype3_1.png";
                wanfaUrl = "res/res_phz/pp/wanfa2_3.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.LDFPF){
                gameTypeUrl = "res/res_phz/pp/gametype3_2.png";
                ldfpf_qihuType = "res/res_phz/phzRoom/" + PHZRoomModel.intParams[13] + "hqh_3.png";
                ldfpf_manbaiType = "res/res_phz/phzRoom/mbjs_3.png"
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.CZZP){
                gameTypeUrl = "res/res_phz/pp/gametype3_3.png";
                var huxi = PHZRoomModel.intParams[11] == 2?6:PHZRoomModel.intParams[11] == 3?3:9;
                ldfpf_qihuType = "res/res_phz/phzRoom/" + huxi + "xqh_3.png";
                var huxizhuanhuan = PHZRoomModel.intParams[10] == 2?1:3;
                ldfpf_manbaiType = "res/res_phz/phzRoom/"+ huxizhuanhuan + "xyt_3.png"
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.LYZP){
                gameTypeUrl = "res/res_phz/pp/gametype3_4.png";
                wanfaUrl = "res/res_phz/phzRoom/10hqh_3.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.WHZ){
                gameTypeUrl = "res/res_phz/pp/gametype3_5.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.HYSHK){
                gameTypeUrl = "res/res_phz/pp/gametype3_hyshk.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.LDS){
                gameTypeUrl = "res/res_phz/pp/gametype3_lds.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.XXGHZ){
                gameTypeUrl = "res/res_phz/pp/gametype3_xxghz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.AHPHZ){
                gameTypeUrl = "res/res_phz/pp/gametype3_ahphz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.GLZP){
                gameTypeUrl = "res/res_phz/pp/gametype3_glzp.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.NXPHZ){
                gameTypeUrl = "res/res_phz/pp/gametype3_nxphz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.XXPHZ){
                gameTypeUrl = "res/res_phz/pp/gametype3_xxphz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.XTPHZ){
                gameTypeUrl = "res/res_phz/pp/gametype3_xtphz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.WCPHZ){
                gameTypeUrl = "res/res_phz/pp/gametype3_wcphz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.JHSWZ){
                gameTypeUrl = "res/res_phz/pp/gametype3_jhswz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.YZCHZ){
                this.Image_manbai.visible = true;
                this.Image_qihu.visible = true;

                gameTypeUrl = "res/res_phz/pp/gametype3_yzchz.png";
                var huxi = PHZRoomModel.intParams[14] || 15;
                ldfpf_qihuType = "res/res_phz/phzRoom/" + huxi + "_hqh_3.png";

                var fengding = "bfd";
                if(PHZRoomModel.intParams[8] == 1)fengding = "300fd";
                if(PHZRoomModel.intParams[8] == 2)fengding = "600fd";
                if(PHZRoomModel.intParams[8] == 3)fengding = "800fd";
                ldfpf_manbaiType = "res/res_phz/phzRoom/" + fengding + "_3.png";

            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.HYLHQ){
                gameTypeUrl = "res/res_phz/pp/gametype3_7.png";
                wanfaUrl = "res/res_phz/phzRoom/"+PHZRoomModel.intParams[21]+"hqh_3.png";
            }
            // wanfaUrl = PHZRoomModel.wanfa == GameTypeEunmZP.SYBP ? "res/res_phz/pp/wanfa1_3.png" : "res/res_phz/pp/wanfa2_3.png";
            bgTexture = "res/res_phz/pp/room_bg3.jpg";
            this.roomName_label.setColor(cc.color(97,76,56));
        }else if (PHZSetModel.zmbj == 4){
            bgTexture = "res/res_phz/pp/room_bg4.jpg";
            this.roomName_label.setColor(cc.color(214,203,173));
        }
        if(gameTypeUrl){
