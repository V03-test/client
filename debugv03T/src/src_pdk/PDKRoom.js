...
var PDKRoom = BaseRoom.extend({//Room
	...
	initData:function(){
		...
		if(this.labelRand){
			this.labelRand.setString("第"+PDKRoomModel.nowBurCount + "/" + PDKRoomModel.totalBurCount+"局");
		}
		...
		if(this.labelRoomId){
			this.labelRoomId.setString("房号:"+PDKRoomModel.tableId);
		}
		//IP相同的显示
	...
	selfRender:function(){
		...
		this.Button_tuichu = this.getWidget("Button_tuichu");//退出
		UITools.addClickEvent(this.Button_tuichu ,this,this.onTuiChu);
