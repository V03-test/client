...
var ClubCreditPop = BasePopup.extend({
    ...
    selfRender:function(){
        ...
        qyqid.setString("亲友苑ID:" + ClickClubModel.getCurClubId());
        ...
        this.findBtnIdnex = 0;//当前选择的切页 0是没有查找 1是查找成员 2是查找门主
        ...
        this.lbMyscore.setString("我的擂台分:0");
        this.lbAllscore.setString("总擂台分:0");

        if(SdkUtil.isIphoneX()){
            this.lbMyscore.y += 15;
            this.lbAllscore.y += 15;
        }
        ...
        this.inputName.setPlaceholderFontColor(cc.color("#2155b5"));
        ...
        this.inputRoom = new cc.EditBox(cc.size(270, 70),new cc.Scale9Sprite("res/ui/bjdmj/popup/light_touming.png"));
        ...
        this.inputRoom.setFont("Arial",40);
        this.inputRoom.setPlaceHolder("房间ID");
        this.inputRoom.setPlaceholderFont("Arial" , 40);
        this.inputRoom.setPlaceholderFontColor(cc.color("#2155b5"));
        ...
        this.inputName1 = new cc.EditBox(cc.size(270, 70),new cc.Scale9Sprite("res/ui/bjdmj/popup/light_touming.png"));
        ...
        this.inputName1.setFont("Arial",40);
        this.inputName1.setFontColor(cc.color(255,255,255));
        this.inputName1.setMaxLength(30);
        this.inputName1.setPlaceHolder("成员ID");
        this.inputName1.setPlaceholderFont("Arial",40);
        this.inputName1.setPlaceholderFontColor(cc.color("#2155b5"));
        ...
        this.Panel_spread = this.getWidget("Panel_spread");//显示门主的界面
        ...
        var img1 = "res/res_ui/qyq/bisaiSet/chakan1.png";
        var img2 = "res/res_ui/qyq/bisaiSet/chakan2.png";
        this.checkNegativePlayerBox = new ccui.CheckBox(img2,img2,img1,null,null,ccui.Widget.LOCAL_TEXTURE);
        this.checkNegativePlayerBox.setPosition(450,355);
        ...
        var dispr = new cc.Scale9Sprite("res/res_ui/qyq/common/commonKuang/dayingjiaDi.png");
        dispr.setContentSize(460,73);
        dispr.setPosition(this.checkNegativePlayerBox.width/2,this.checkNegativePlayerBox.height/2);
        ...
        var widgetShaixuan = {"Button_shaixuan_1" : 1  , "Button_shaixuan_2" : 2, "Button_shaixuan_3" : 3, "Button_shaixuan_4" : 4, "Button_shaixuan_5" : 5};
        ...
        if(ClickClubModel.getIsSwitchCoin() && ClickClubModel.isClubCreaterOrLeader()){
            removeBtnList = [1,2];//暂时去掉奖赏排行
        }
        if (ClickClubModel.isClubNormalMember()){
            removeBtnList = [0,1,2,4,6,7];//暂时去掉奖赏排行
        }
        ...
        this.item_radio_xiala.setPosition(-100,360);
        this.item_radio_xiala.setVisible(true);
    ...
    displaySorts:function(){
        ...
        var img1 = "res/res_ui/qyq/common/commonButton/jts1.png";
        var img2 = "res/res_ui/qyq/common/commonButton/jtx1.png";
    ...
    changeClubRadio:function(radio){
        ...
        if(!ClickClubModel.isClubCreater()){
            FloatLabelUtil.comText("只有擂主才能修改");
            return;
        }
        var self = this;
        var str = "修改后分成区间奖赏分的设置保持原有设置,请谨慎操作";
    ...
    setXialaType:function(type){
        ...
        var str = "全部";
        var configArr = ["全部", "转移擂台分", "奖赏分", "输赢分", "洗牌分"];
        if(configArr[type]){
            str = configArr[type];
        }
    ...
    onBtnListClick: function(obj){
        ...
        * **/
        if (temp == 1){
            ...
            this.pageBg.visible = true;
            //this.pageBg.x = 304;
            this.lbAllGmaes.setString("总奖赏分:0")
        }else if( temp == 4){
            ...
            for(var i=1;i <= 2;i++){
                this["img_sort_" + i].loadTexture("res/res_ui/qyq/common/commonButton/jtx1.png")
            ...
            if (data) {
                if(self){
                    ...
                    if (data.message){
                        ...
                        self.lbMyscore.setString("我的擂台分:"+myScore);
                        self.lbAllscore.setString("总擂台分:"+allScore);
                    }
                }
    ...
    getGroupExpLogData:function(curPage){
        ...
        NetworkJT.loginReqNew("groupActionNew", "loadGroupExpLog", {
            userId:PlayerModel.userId,
            groupId:ClickClubModel.getCurClubId(),
            pageNo:page,
            pageSize:this.maxPageSize,
        ...
        NetworkJT.loginReqNew(200, {
            ...
            if (data) {
                ...
                if(data[rankType].length > 0){//获取当前页 有数据的情况
                    ...
                    self.lbAllGmaes.setString("总奖赏数:"+dataTypeSumValue);
    ...
    /**
     * 获取战绩数据
     * 增加参数：tableType  -1：全部，0：非擂台房，1：正常房 2：擂台房
     */
            ...
            if (data) {
                if(self){
                    ...
                    if (data.message){
                        ...
                        self.lbAllGmaes.setString("总奖赏分:"+total);
                    }
                }
    ...
    showRuleText:function(){
        var str = "擂台房管理界面规则："	+
            "\n1、擂主在设定下级分成时优先确定好选择分成模式（大赢家分成，参与分成）；"+
            "\n2、大赢家分成模式：由牌局的大赢家所对应的上级门主或合伙人然后一级一级往上找上级最终到擂主，每一级都按上级给下级的奖赏分成设定值来进行奖赏分的分配；"+
            "\n3、参与分成模式：在牌局中所有参与的成员找到对应上级门主或合伙人然后各自一级级往上找上级最终到擂主，每一级都按上级给下级的奖赏分设定值来进行奖赏分的分配；"+
            "\n4、擂主、合伙人以及各级门主需要对自己的下级进行按包厢玩法单独设定分成值，各级所拥有的可分配奖赏分为上级设定值；"+
            "\n5、擂主、副擂主、合伙人以及各级门主和普通成员可通过ID查询成员来给玩家上分，除擂主和副擂主外其他人只能查出自己关系链的成员包括上级和下级；" +
            "\n6、除擂主副擂主外其他合伙人、各级门主以及普通成员都只开放上分功能，不能给玩家下分；" +
            "\n7、擂主、合伙人以及各级门主可通过ID查询自己下级信息，可单独对其进行分成设定；" +
            "\n8、在发展门主页签中通过id查询出对应玩家后，若本身为自己组的成员则可以升级为门主，若不在该亲友圈中需先拉人进组，若已经为自己的下级门主则可删除门主的操作；"
    ...
    onWaysClick:function(obj){
        ...
        var str = "";
        if ( temp== 1){
            str = "修改分成模式为大赢家分成，确定修改吗？确定后需通知所有合伙人以及门主及时修改奖赏分成设置";
        }else{
            str = "修改分成模式为参与分成，确定修改吗？确定后需通知所有合伙人以及门主及时修改奖赏分成设置";
        }
