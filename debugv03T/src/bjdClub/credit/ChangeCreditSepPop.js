...
var ChangeCreditSepPop = BasePopup.extend({
    ...
    selfRender:function(){
        ...
        this.title_tip_1.setString("您正在对\"" + UITools.truncateLabel(this.optItem.data.teamName,10) + "\"(" +this.optItem.data.userId +")进行奖赏分操作");
    ...
    onClickSureBtn:function(){
        var self = this;
        var tip = "确定后该下级将按最新奖赏分成值进行分成，是否确定修改？";
