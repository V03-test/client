...
var ClubRecallDetailModel = {
    ...
    *返回玩法
    ...
    getYYMJWanfa:function(wanfaList,isNotGame){
        ...
        infoArr.push(wanfaList[0] + "局");
        if(!ClickClubModel.getClubIsGold())
        infoArr.push(wanfaList[2] == 3?"擂主支付":wanfaList[2] == 2?"房主支付":"AA支付");
    ...
    getZZPHWanfa:function(wanfaList,isNotGame,isGoldRoom){
        ...
        if(!isGoldRoom){
            ...
            infoArr.push(wanfaList[0] + "局");
            if(!ClickClubModel.getClubIsGold())
                infoArr.push(wanfaList[2] == 3?"擂主支付":wanfaList[9] == 2?"房主支付":"AA支付");
        }
  ...
  getXTBPWanfa:function(wanfaList,isNotGame){
    ...
    getYJMJWanfa:function(wanfaList,isNotGame){
        ...
        infoArr.push(wanfaList[0] + "局");
        if(!ClickClubModel.getClubIsGold())
        infoArr.push(wanfaList[10] == 3?"擂主支付":wanfaList[10] == 2?"房主支付":"AA支付");
    ...
    getDissPlayerStr:function(resultMsg){
        var dissStr = "注：";
        var dissState = resultMsg.dissState;  //0正常结束1是擂主解散2是中途玩家申请解散
        if (dissState == 1){
            dissStr = "注：擂主解散房间";
        }else if (dissState == 2){
            dissStr = "注：";
