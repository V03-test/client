...
var ClubKickPlayerCell = ccui.Widget.extend({
    ctor:function(data,root,index){
        ...
        var Image_bg = this.Image_bg = UICtor.cImg("res/res_ui/homeLayer/xiaoxi/di.png");
        ...
        var Image_head=this.Image_head= UICtor.cImg("res/res_ui/homeLayer/head_kuang.png");
        ...
        var Button_choose=this.Button_choose= UICtor.cBtn("res/res_ui/qyq/common/commonButton/checkBox2.png");
        ...
        Button_choose.loadTextureDisabled("res/res_ui/qyq/common/commonButton/checkBox1.png", 0);
...
var ClubKickPlayerPop = BasePopup.extend({
    ...
    showBtnState:function(){
        ...
        if (this.creditLimit){
            ...
            this.menber_time.setString("擂台分");
        }
    },
