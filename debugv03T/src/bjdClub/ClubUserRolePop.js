...
var ClubUserRolePop = BasePopup.extend({
    ...
    showRoleList:function(){
        ...
        this.mianPopup.setContentSize(this.mianPopup.width,roleNum * 93 + 10);
    ...
    onSendAllotUser:function(event){
        ...
        NetworkJT.loginReqNew(422,params , function (data) {
    ...
    onUpdateUserRole:function(sender){
        ...
        AlertPop.show(str,function() {
            NetworkJT.loginReqNew(438,params , function (data) {
                if (data && data.code == 0 && data.message) {
    ...
    onDeleteUser:function(sender){
        ...
        var self = this;
        AlertPop.show(str,function() {
            NetworkJT.loginReqNew(407,params , function (data) {
                if (data && data.code == 0 && data.message) {
...
var ClubOptForbidGamePop = cc.Layer.extend({
    ...
    setLayerWithData:function(){
        ...
        if(this.optData.userRole == 2 || this.optData.userRole == 90000){//副擂主或普通成员
    ...
    initLayer:function(){
        var layerBg = new cc.Sprite("res/res_ui/qyq/common/commonKuang/tanchuangBg.png");
        ...
        btn_close.setPosition(layerBg.width - 75,layerBg.height - 75);
        ...
        label_title.setColor(cc.color("#FF9D734F"));
        label_title.setPosition(layerBg.width/2,layerBg.height - 85);
        layerBg.addChild(label_title);

        var img_head = new cc.Sprite("res/res_ui/homeLayer/head_kuang.png");
        img_head.setPosition(layerBg.width/2 - 120,layerBg.height/2 + 120);
        ...
        label_name.setColor(cc.color("#91371f"));
