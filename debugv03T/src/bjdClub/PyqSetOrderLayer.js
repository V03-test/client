...
var PyqSetOrderLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        var bg = new cc.Scale9Sprite("res/res_ui/qyq/wanfa/paixuDi1.png");
        ...
        var bg2 = new cc.Scale9Sprite("res/res_ui/qyq/wanfa/paixuDi2.png");
        ...
        bg2.addChild(this.itemScroll,1);
    ...
    addBagItems:function(data){
        ...
        this.posArr = [];
        for(var i = 0;i<num;++i){
            var item = new cc.Scale9Sprite("res/res_ui/qyq/wanfa/pxBtnBg.png");
            item.setPosition((i%4 + 1)*itemW,contentH - (Math.floor(i/4) + 0.5)*itemH);
            item.setContentSize(item.width + 150,item.height + 40);
            item.flag = i;
            ...
            var bgKuang = new cc.Scale9Sprite("res/res_ui/qyq/wanfa/pxBtnDi.png");
            ...
            var idx = UICtor.cLabel(i+1,45);
            idx.setTag(1);
            idx.setPosition(30,item.height/2);
            idx.setColor(cc.color(208,19,27));
            item.addChild(idx);

            var name = UICtor.cLabel(data[i].groupName,45);
            name.setAnchorPoint(0,0.5);
            name.setPosition(70,item.height/2);
    ...
    updateGroupTableConfig:function(data){
        ...
        var self = this;
        NetworkJT.loginReqNew(434,params, function (data) {
            if (data) {
