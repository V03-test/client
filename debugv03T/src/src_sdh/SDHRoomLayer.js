...
var SDHRoomLayer = SDHBaseRoomLayer.extend({
    ...
    addRoomTitle:function(){
        var spr = new cc.Sprite("res/res_yybs/sdh.png");
    ...
    addBottomBtn:function(){
        ...
        this.btn_dipai = new ccui.Button(img,img,"");
    ...
    addRoomBtn:function(){
        ...
        this.btn_tuichu.visible = !SDHRoomModel.replay;
    ...
    handleTableData:function(type,data){
        ...
        if(type == SDHTabelType.CreateTable){
            ...
            var message = {closingPlayers:[{userId:"120073",name:"lx7788",leftCardNum:0,point:-12,totalPoint:-11,boom:0,winCount:null,
                lostCount:null,maxPoint:null,totalBoom:null,cards:[],seat:1,sex:1,
                icon:"http://thirdwx.qlogo.cn/mmopen/vi_32/Dv2csZTBP5wJupj6zKibIuaaZkwphVDBX012k4btO0wticrvROE4UhYkxAsF0hETSXgibtLgTFxu2DSNRzkDTsEFw/132",isHu:null,actionCounts:[],gangIds:[],dahus:[],xiaohus:[],
                ext:[0,0,0,0,0,0,-1100,0,-1],gold:null,credit:null,winLoseCredit:-1100,commissionCredit:0,goldFlag:null},
                {userId:"120052",name:"lx5566",leftCardNum:0,point:24,totalPoint:22,boom:1,winCount:null,lostCount:null,maxPoint:null,
                    totalBoom:null,cards:[],seat:2,sex:1,icon:"",isHu:null,actionCounts:[],gangIds:[],dahus:[],xiaohus:[],
                    ext:[0,0,0,0,0,0,2200,0,-1],gold:null,credit:null,winLoseCredit:2200,commissionCredit:0,goldFlag:null},
                {userId:"120004",name:"lx1234",leftCardNum:0,point:-12,totalPoint:-11,boom:0,winCount:null,lostCount:null,maxPoint:null,
                    totalBoom:null,cards:[],seat:3,sex:1,icon:"",isHu:null,actionCounts:[],gangIds:[],dahus:[],xiaohus:[],
                    ext:[0,0,0,0,0,0,-1100,0,-1],gold:null,credit:null,winLoseCredit:-1100,commissionCredit:0,goldFlag:null}],
                bird:[],birdSeat:[],isBreak:0,wanfa:231,ext:[265194,120004,"2020-12-12 14:21:38",231,2,1,0,1,8,3,2,0,3071,
                1,10000,100,100,0,1,1,0,0,50,0,0,1,0],matchExt:[],cutCard:[],cutDtzCard:[],groupLogId:null,intParams:[]};

            //ClosingInfoModel.init(message);
            //var layer = new SDHSmallResultLayer(message);
