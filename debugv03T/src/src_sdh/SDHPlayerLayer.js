...
var SDHPlayerLayer = cc.Layer.extend({
    ...
    handleTableData:function(type,data){
        if(type == SDHTabelType.CreateTable){
            this.players[1].setVisible(SDHRoomModel.renshu > 2);
            this.players[2].setVisible(SDHRoomModel.renshu != 3);
            this.players[3].setVisible(SDHRoomModel.renshu > 2);
    ...
    playTxtAni:function(localSeat,txtStr){
        ...
        var bg = new cc.Scale9Sprite("res/res_sdh/img_14_c.png");
...
var SDHPlayerNode = cc.Node.extend({
    ...
    initNode:function(){
        ...
        playerBg.setRotation(90);
        playerBg.setPositionY(68);
        ...
        this.label_name = UICtor.cLabel("玩家的名字",24);
        ...
        this.label_score = UICtor.cLabel("分:12345",24);
        this.label_score.setColor(cc.color("#ffe066"));
        this.addChild(this.label_score);

        this.label_sai = UICtor.cLabel("赛:12345678",24);
        this.label_sai.setColor(cc.color("#ffe066"));
        this.addChild(this.label_sai);

        this.image_coin = new cc.Sprite("res/res_sdh/img_jinbi.png");
        this.addChild(this.image_coin);

        this.label_coin = UICtor.cLabel("12345678",24);
        this.label_coin.setColor(cc.color("#ffe066"));
        this.label_coin.setAnchorPoint(0,0.5);
        this.addChild(this.label_coin);

        this.icon_zhuang = new cc.Sprite("res/res_sdh/zhuang.png");
        ...
        this.icon_zhunbei = new cc.Sprite("res/res_sdh/zhunbei.png");
        this.addChild(this.icon_zhunbei);

        this.label_JiaoFen = new cc.LabelBMFont("","res/res_sdh/font/show_jiaofen.fnt");
        this.addChild(this.label_JiaoFen);

        this.baofu_bg = new cc.Scale9Sprite("res/res_sdh/baofu_bg.png");
    ...
    setPosWithIdx:function(idx){
        ...
        switch (idx) {
            case 0:
                ...
                this.label_name.setPosition(90,-23);
                ...
                break;
            case 1:
                this.label_name.setPosition(0,-80 - 20);
                this.label_score.setPosition(0,-120 - 20);
                this.label_sai.setPosition(0,-160 - 20);
                this.icon_zhuang.setPosition(55,55);
                this.icon_tuoguan.setPosition(-55,55);
                this.icon_zhunbei.setPosition(-230,0);

                this.yybg.setPosition(-75,15);
                this.image_coin.setPosition(-45,-160 - 20);
                this.label_coin.setPosition(-23,-160 - 20);
                break;
            case 2:
        ...
        var localScale = idx != 0 ? 1 : 1.1;
        this.label_name.setScale(localScale);
        this.label_score.setScale(localScale);
        this.label_sai.setScale(localScale);
        this.label_coin.setScale(localScale);
    ...
    cleanData:function(){
        ...
        if(SDHRoomModel.wanfa == GameTypeEunmPK.XTSDH){
            if(SDHRoomModel.isFzbHide() && !SDHRoomModel.replay){
                this.iconSpr.setVisible(true);
