...
var CDTLJRoomLayer = CDTLJBaseRoomLayer.extend({
    ...
    addRoomTitle:function(){
        var spr = new cc.Sprite("res/res_cdtlj/cdtlj.png");
    ...
    addBottomBtn:function(){
        ...
        this.btn_card_record.setPosition(cc.winSize.width - 150,42);
        this.addChild(this.btn_card_record,2);

        img = "res/res_yybs/btn_chs.png";
        this.btn_chs = new ccui.Button(img,img,"");
        this.btn_chs.setPosition(this.btn_card_record.x - 260,42);
        this.addChild(this.btn_chs,2);

        img = "res/res_yybs/dipai.png";
        this.btn_dipai = new ccui.Button(img,img,"");
        this.btn_dipai.setPosition(this.btn_chs.x - 260,42);
    ...
    addRoomBtn:function(){
        ...
        this.btn_tuichu.visible = !CDTLJRoomModel.replay;
        ...
        if(!hasTuichu){
            ...
            if(this.btn_qyq_back){
                if(this.btn_invite_qyq){
                    ...
                    this.btn_invite_qyq.x = -150;
                    this.btn_qyq_back.x = 150;
                    this.btn_tuichu.x = cc.winSize.width/2 + 450;
                }else{
                    this.btn_invite_wx.x = -350;
