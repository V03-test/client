...
var YYBSRoomModel = {
    ...
    getCreditConfigStr:function(){
        ...
        if(this.creditConfig[0]){
            ...
            str += ("底分:" + difen + "\n");
            str += ("奖赏分:" + giveNum + (giveType == 1?"":"%") + "\n");
            str += ("奖赏方式:" + (giveWay == 1?(this.creditConfig[12] && this.creditConfig[12] != 0 ?"AA奖赏":"大赢家"):"所有赢家") + "\n");
            str += ("奖赏类型:" + (giveType == 1?(this.creditConfig[12] && this.creditConfig[12] != 0 ?"":"固定奖赏"):"比例奖赏"));
