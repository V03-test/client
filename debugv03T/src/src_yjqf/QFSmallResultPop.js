...
var QFSmallResultPop = BasePopup.extend({
    ...
    selfRender: function () {
        ...
        this.btn_xipai = new ccui.Button("res/res_yjqf/qfSmallResult/xipai.png", "res/res_yjqf/qfSmallResult/xipai.png");
        this.btn_xipai.setPosition(btnok.x + 250, btnok.y);
        this.addChild(this.btn_xipai, 2);
        if ((QFRoomModel.nowBurCount == QFRoomModel.totalBurCount) || (parseInt(ClosingInfoModel.gotoBigResult) > 0)) {
            this.btn_xipai.visible = false;
        }else{
            this.btn_xipai.visible = false;//QFRoomModel.creditConfig[10] == 1;
            //if(QFRoomModel.creditConfig[10] == 1){
            //    btnok.x -= 150;
            //}
        }
        this.btn_xipai.visible = true;
        var bisaiImg = new cc.Sprite("res/ui/bjdmj/popup/pyq/sai.png");
        bisaiImg.setPosition(175, 70);
        this.btn_xipai.addChild(bisaiImg);

        var numStr = QFRoomModel.creditXpkf ? ""+QFRoomModel.creditXpkf : "0";
        var label_xpkf = UICtor.cLabel(numStr,50);
