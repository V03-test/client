 ...
 */
var DYBPLayout = cc.Class.extend({
    ...
    chuPai:function(mjVo,notTi){
        ...
        if(this.direct==1)
            DYBPMineLayout.delOne(mjVo,true);
    },
            ...
            if(action==PHZAction.TI||action==PHZAction.PAO){//先偎后提、跑
                for(var i=0;i<this.data2.length;i++){
                    ...
                    if( innerObject.action==PHZAction.WEI
                        ...
                        if(this.direct != 1 && isZaiPao == 1 && PHZRoomModel.wanfa == GameTypeEunmZP.NXPHZ && innerObject.action==PHZAction.WEI){
                            if(vo.c<=0){
                        ...
                        if(this.direct != 1 && isZaiPao == 1 && PHZRoomModel.wanfa == GameTypeEunmZP.SMPHZ && innerObject.action==PHZAction.WEI){
                            if(vo.c<=0){
                                this.assignInnerObjectByPao(innerObject,action,ids[0]);
                                hasInsert = true;
                                break;
            ...
            for(var j=0;j<innerArray.length;j++){
                ...
                switch (innerAction){
                    case PHZAction.WEI://偎
                        ...
                        if(PHZRoomModel.wanfa == GameTypeEunmZP.LDS || PHZRoomModel.wanfa == GameTypeEunmZP.YZCHZ){//落地扫偎牌别人全暗，自己全显示暗一点
                    ...
                    case 18://岳阳歪胡子的起手4张溜，全部扑牌不显示
                        ...
                        if(PHZRoomModel.wanfa == GameTypeEunmZP.LDS || PHZRoomModel.wanfa == GameTypeEunmZP.YZCHZ){//落地扫提牌牌别人全暗，自己全显示暗一点
                            if(this.direct != 1 && !isOver)innerVo.a = 1;
                            else {
                                innerVo.a = 0;
                                innerVo.zhe = 1;
