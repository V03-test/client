...
var PHZAlertPop = BasePopup.extend({
...
PHZAlertPop.show = function(content,okcb,cancelcb,btnType,tipStr){
	var mc = new PHZAlertPop(content,okcb,cancelcb,btnType,tipStr);
