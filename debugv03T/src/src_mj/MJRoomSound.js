...
var MJRoomSound = {
    ...
    getPath:function(sex,audioName){
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.DZMJ){
            var type = cc.sys.localStorage.getItem("pro003_mj_yuyan"+MJRoomModel.wanfa) || 2;
            if(type == 2){
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.CSMJ || MJRoomModel.wanfa == GameTypeEunmMJ.TDH
           ...
           var type = parseInt(cc.sys.localStorage.getItem("pro003_mj_yuyan"+MJRoomModel.wanfa))||cc.sys.localStorage.getItem("pro003_mj_yuyan") || 1;
            if(type === 1){
