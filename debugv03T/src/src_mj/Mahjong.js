/**
 * Created by zhoufan on 2016/7/22.2
 */
var Mahjong = ccui.Widget.extend({
    ...
    diplay:function(){
        ...
        var ziFlippedX = false;
        var mjScale = 1;
        var bgstyle = UITools.getLocalItem("pro003_mj_pp"+MJRoomModel.wanfa)||UITools.getLocalItem("pro003_mj_pp") || 1; //1 绿色 2 黄色
        var mjstyle = UITools.getLocalItem("pro003_mj_pm"+MJRoomModel.wanfa)||UITools.getLocalItem("pro003_mj_pm") || 1; //1 旧麻将 2 新麻将;
