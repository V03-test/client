...
var ClubCreditRecordCell = ccui.Widget.extend({
    ...
    ctor:function(data ,index, parentNode){
        ...
        this._super();
        this.setContentSize(1530, 130);

        var Panel_21=this.Panel_21= UICtor.cPanel(cc.size(1530,130),cc.color(126,49,2),0);
        Panel_21.setAnchorPoint(cc.p(0,0));
        Panel_21.setPosition(0,0);
        var imgBg=this.imgBg= new cc.Scale9Sprite("res/res_ui/qyq/common/commonKuang/xinxiTiao.png",null,cc.rect(40,30,40,30));
        this.imgBg.setContentSize(1530, 130);
        imgBg.setScale9Enabled(true);
        imgBg.setPosition(765,65);
