...
var HSTHPlayerLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        for(var i = 0;i<4;++i){
            ...
            if(i == 1)pos = cc.p(cc.winSize.width - 105,cc.winSize.height/2 + 330);
...
var HSTHPlayerNode = cc.Node.extend({
    ...
    setPlayerWithData:function(data){
        ...
        if(HSTHRoomModel.isClubGoldRoom()){
    ...
    initNode:function(){
        ...
        var tip1 = new cc.Sprite("res/res_diantuo/zongfen.png");
        ...
        var tip2 = new cc.Sprite("res/res_diantuo/xifen.png");
        ...
        this.label_score.setPosition(this.fenbg1.width/2 + 45,this.fenbg1.height/2);
        this.fenbg1.addChild(this.label_score);

        this.label_ext_score = UICtor.cLabel("123",33);
        this.label_ext_score.setPosition(this.fenbg2.width/2 + 45,this.fenbg2.height/2);
        ...
        this.warningSpr = new cc.Sprite("res/res_gameCom/warning.png");
        this.addChild(this.warningSpr);

        this.tipSpr = new cc.Sprite("res/res_diantuo/duzhan.png");
        this.addChild(this.tipSpr,3);

        this.paiBei = new ccui.ImageView("res/res_diantuo/paibei.png");
        ...
        this.icon_zhuang = new cc.Sprite("res/res_hsth/zhuang.png");
        this.icon_zhuang.setScale(0.8);
        this.addChild(this.icon_zhuang,2);

        this.icon_zhuang.setPosition(-53,-45);

        this.mingpai_bg = new cc.Scale9Sprite("res/res_hsth/baofu_bg.png");
    ...
    setPosWithIdx:function(idx){
        ...
        switch (idx) {
            case 0:
                this.label_name.setPosition(0,83);

                this.fenbg1.setPosition(150,8);
                this.fenbg2.setPosition(150,-40);

                this.label_sai.setAnchorPoint(0,0.5);
                this.label_sai.setPosition(60,53);

                this.label_coin.setPosition(100,53);
                this.image_coin.setPosition(75,53);

                this.icon_tuoguan.setPosition(55,55);
                this.icon_zhunbei.setPosition(this.convertToNodeSpace(cc.p(cc.winSize.width/2,225)));
                this.yaobuqiSpr.setPosition(this.convertToNodeSpace(cc.p(cc.winSize.width/2,600)));
        ...
        if(idx == 2){
            this.playerBg.setAnchorPoint(0.5,0.5);
            this.playerBg.setRotation(0);
            this.playerBg.setPositionY(0);
            this.playerBg.setPositionX(-68);
        }else{
