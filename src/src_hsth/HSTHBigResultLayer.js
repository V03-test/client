...
//            this.label_credit_config.setString(HSTHRoomModel.getClubGlodCfg());
//        }
//
...
//
//        var img_title = new cc.Sprite("res/res_hsth/paijiujiesuan.png");
...
//
//    initNode:function(){
//        var img = "res/res_hsth/score_di.png";
...
//
//        this.headBg = new cc.Sprite("res/res_hsth/touxiangkuang.png");
//        this.headBg.setPosition(this.nodeBg.width/2,this.nodeBg.height - 90);
//        this.nodeBg.addChild(this.headBg);
//
//        this.icon_fangzhu = new cc.Sprite("res/res_hsth/fangzhu.png");
...
//
//        this.icon_dyj = new cc.Sprite("res/res_hsth/icon_dyj.png");
...
//                txt.visible = false;
//
//                var img = "res/res_hsth/icon_sai.png";
//
//                if(HSTHRoomModel.isClubGoldRoom()){
...
//        }else if(HSTHRoomModel.isClubGoldRoom()){
//            var credit = data.winLoseCredit;
...
var HSTHBigResultLayer = PKBigResultPop.extend({
    user:null,
    ...
    refreshSingle:function(widget,user){
        ...
        var itemArr = ["赢牌次数","最高总分","一游次数","","",""];

        var otherArr = [""+(user.actionCounts[0] || 0),
            ""+(user.actionCounts[1] || 0),
    ...
    selfRender: function () {
        ...
        //显示部分房间信息
        var wanfaDesc = ClubRecallDetailModel.getSpecificWanfa(HSTHRoomModel.intParams);

        this.getWidget("Label_wanfa").setString(wanfaDesc);


        var jushuStr = "第" + HSTHRoomModel.nowBurCount + "/" + HSTHRoomModel.totalBurCount + "局";
        ...
        if (HSTHRoomModel.isCreditRoom()){
            this.getWidget("Label_score").setString(HSTHRoomModel.getCreditConfigStr());
        }

        if(HSTHRoomModel.isClubGoldRoom()){
            this.getWidget("Label_score").setString(HSTHRoomModel.getClubGlodCfg());
        }
    },
