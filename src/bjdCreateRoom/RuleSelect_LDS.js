...
var RuleSelect_LDS = RuleSelectBase.extend({
    ...
    setConfigData:function(){
        this.ruleConfig = [
            ...
            {title:"可选",type:2,content:["双醒","首局随机庄"],col:3},//5
        ...
        if(this.createRoomLayer.clubData){
            ...
            if(params[1] == GameTypeEunmZP.LDS){
    ...
    createNumBox:function (row) {
        ...
        var scoreLabel = this.scoreLabel = UICtor.cLabel("小于"+this.ldsDScore+"分",38,null,cc.color(126,49,2));
    ...
    getSocketRuleData:function(){
        ...
        var sjsjz = 0;
        if(this.getItemByIdx(5,1).isSelected())sjsjz = 1;
    ...
    getWanfas:function(){
        ...
        return [GameTypeEunmZP.LDS,costWay,jushu,renshu];
    ...
    readSelectData:function(params){
        ...
        if(params[16] == "1")defaultConfig[5].push(1);//首局随机庄
