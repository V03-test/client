...
var CDTLJBaseRoomLayer = cc.Layer.extend({
    _dt:0,
    _timedt:0,
    _customEvents:null,
    ctor:function(){
    ...
    addMenuLayer:function(){
        this.menuBtnLayer = new CDTLJMenuBtnLayer();
    ...
    onClickGpsBtn:function(){
        if(CDTLJRoomModel.renshu > 2){
            var pop = new GpsPop(CDTLJRoomModel , CDTLJRoomModel.renshu);
