...
// */
//
//var CDTLJBigResultLayer = cc.Layer.extend({
...
//
//        this.label_credit_config.setString(CDTLJRoomModel.getCreditConfigStr());
//
//        if(CDTLJRoomModel.isClubGoldRoom()){
//            this.label_credit_config.setString(CDTLJRoomModel.getClubGlodCfg());
//        }
//
...
//
//        var img1 = new cc.Sprite("res/res_cdtlj/jiesuan/dia.png");
//        img1.setAnchorPoint(0.5,1);
//        img1.setPosition(cc.winSize.width/2,cc.winSize.height);
//        this.addChild(img1);
//
//        var img_title = new cc.Sprite("res/res_cdtlj/jiesuan/paijiujiesuan.png");
...
//
//        this.btn_back = new ccui.Button("res/res_cdtlj/jiesuan/back.png","res/res_cdtlj/jiesuan/back.png");
...
//            var item = new CDTLJBigResultItem();
...
//        var table = "牌桌号:" + CDTLJRoomModel.tableId;
//        var jushu = "局数:" + CDTLJRoomModel.nowBurCount + "/" + CDTLJRoomModel.totalBurCount;
//
...
//        var wanfa = CDTLJRoomModel.wanfa;
...
//        var obj={};
//        var tableId = CDTLJRoomModel.tableId;
//        obj.tableId=tableId;
...
//});
//
//var CDTLJBigResultItem = cc.Node.extend({
//    ctor:function(){
//        this._super();
//
//        this.initNode();
...
//
//    initNode:function(){
//        var img = "res/res_cdtlj/jiesuan/image_toumingdi.png";
//        this.nodeBg = new cc.Scale9Sprite(img);
//        this.nodeBg.setContentSize(1710,165);
//        this.addChild(this.nodeBg);
//
//        this.headBg = new cc.Sprite("res/res_cdtlj/touxiangkuang.png");
...
//
//        this.icon_fangzhu = new cc.Sprite("res/res_cdtlj/jiesuan/fangzhu.png");
...
//            this.nodeBg.initWithFile("res/res_cdtlj/jiesuan/image_zijidi.png",cc.rect(0,0,116,113),cc.rect(38,38,38,38));
//            this.nodeBg.setContentSize(1710,165);
//        }
//
...
//
//        this.label_credit.setVisible(CDTLJRoomModel.isCreditRoom());
//
//        if(CDTLJRoomModel.isClubGoldRoom()){
...
var CDTLJBigResultLayer = PKBigResultPop.extend({
    user:null,
    ...
    refreshSingle:function(widget,user){
        ...
        if (CDTLJRoomModel.isCreditRoom()){
    ...
    selfRender: function () {
        ...
        if(this.data.length == 1){
            this.getWidget("user2").visible = false;
        ...
        //显示部分房间信息
        var wanfaDesc = ClubRecallDetailModel.getSpecificWanfa(CDTLJRoomModel.intParams);

        this.getWidget("Label_wanfa").setString("常德拖拉机  "+wanfaDesc);


        var jushuStr = "第" + CDTLJRoomModel.nowBurCount + "/" + CDTLJRoomModel.totalBurCount + "局";
        this.getWidget("Label_jushu").setString(jushuStr);

        this.getWidget("Label_roomnum").setString("房号:" + CDTLJRoomModel.tableId);

        this.getWidget("Label_score").setString("");
        if (CDTLJRoomModel.isCreditRoom()){
            this.getWidget("Label_score").setString(CDTLJRoomModel.getCreditConfigStr());
        }

        if(CDTLJRoomModel.isClubGoldRoom()){
            this.getWidget("Label_score").setString(CDTLJRoomModel.getClubGlodCfg());
        }
    },
