...
var NSBBigResultLayer = cc.Layer.extend({
    ...
    setLayerWithData:function(){
        ...
        if(NSBRoomModel.isClubGoldRoom()){
            this.label_credit_config.setString(NSBRoomModel.getClubGlodCfg());
        }
    ...
    initLayer:function(){
        ...
        var img_title = new cc.Sprite("res/res_nsb/paijiujiesuan.png");
...
var NSBBigResultItem = cc.Node.extend({
    ...
    initNode:function(){
        var img = "res/res_nsb/score_di.png";
        ...
        this.headBg = new cc.Sprite("res/res_nsb/touxiangkuang.png");
        this.headBg.setPosition(this.nodeBg.width/2,this.nodeBg.height - 90);
        this.nodeBg.addChild(this.headBg);

        this.icon_fangzhu = new cc.Sprite("res/res_nsb/fangzhu.png");
        ...
        this.icon_dyj = new cc.Sprite("res/res_nsb/icon_dyj.png");
    ...
    addScoreItem:function(scoreArr){
        ...
        for(var i = 0;i<scoreArr.length;++i){
            ...
            if(i == 1){
                ...
                var img = "res/res_nsb/icon_sai.png";
    ...
    setItemWithData:function(data,isFangZhu,isDyj){
        ...
        }else if(NSBRoomModel.isClubGoldRoom()){
            scoreArr.push(data.winLoseCredit || 0);
        }
