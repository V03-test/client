...
/*        var mc = new ChatPop("res/phzChat.json");
    ...
    onOver:function(event){
        ...
        if(PHZRoomModel.intParams[5] == 1){//翻醒效果
    ...
    updateRoomInfo:function(){
        ...
        if(this.lable_GameName){
            this.lable_GameName.setString("永州扯胡子")
        }
    ...
    onInvite:function(){
        ...
        obj.description = clubStr + csvhelper.strFormat("永州扯胡子，{0}人，{1}", PHZRoomModel.renshu, wanfaDesc);
        obj.shareType=1;
        //SdkUtil.sdkFeed(obj);
        ShareDTPop.show(obj);
    },
