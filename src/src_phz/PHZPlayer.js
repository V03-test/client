...
var PHZPlayer = cc.Class.extend({
    ...
    ctor:function(vo,root,seq){
        ...
        this.iconWidget = ccui.helper.seekWidgetByName(root,"Image_bg"+seq);
        ...
        this.Image_goldBg = ccui.helper.seekWidgetByName(root,"Image_goldBg_"+seq);
        if (this.creditScore){
...
/*        if(WXHeadIconManager.loadedIconListInRoom[this._playerVo.userId])
        ...
        if(this._iconUrl == url)
            return;
        if(this.iconWidget.getChildByTag(345))
            this.iconWidget.removeChildByTag(345);
        this._iconUrl = url;
        ...
        if(this._playerVo.icon){
            ...
            try{
                ...
                if (PHZRoomModel.is3Ren()) {
                    this.iconWidget.addChild(clipnode,5,345);
                } else {
                    this.iconWidget.addChild(clipnode,5,345);
                }
                var self = this;
            ...
            sprite.x = 46;
            sprite.y = 45;
            this.iconWidget.addChild(sprite,5,345);
        }
    },
