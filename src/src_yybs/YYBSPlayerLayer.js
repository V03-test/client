...
var YYBSPlayerLayer = cc.Layer.extend({
    ...
    playTxtAni:function(localSeat,txtStr){
        ...
        var bg = new cc.Scale9Sprite("res/res_yybs/img_14_c.png");
...
var YYBSPlayerNode = cc.Node.extend({
    ...
    setTipSpr:function(type){
        if(type == 1){
            ...
            this.tipSpr.initWithFile("res/res_yybs/duzhan.png");
        }else if(type == 2){
            this.tipSpr.setVisible(true);
            this.tipSpr.initWithFile("res/res_yybs/team_icon.png");
        }else{
    ...
    initNode:function(){
        ...
        var headKuang = new cc.Sprite("res/res_yybs/touxiangkuang.png");
        ...
        this.image_coin = new cc.Sprite("res/res_yybs/img_jinbi.png");
        ...
        this.icon_zhuang = new cc.Sprite("res/res_yybs/zhuang.png");
        ...
        this.icon_zhunbei = new cc.Sprite("res/res_yybs/zhunbei.png");
        this.addChild(this.icon_zhunbei);

        this.label_JiaoFen = new cc.LabelBMFont("","res/res_yybs/font/show_jiaofen.fnt");
        this.addChild(this.label_JiaoFen);

        this.baofu_bg = new cc.Scale9Sprite("res/res_yybs/baofu_bg.png");
        ...
        this.tipSpr = new cc.Sprite("res/res_yybs/duzhan.png");
