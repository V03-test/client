...
var TouXiangTipLayer = BasePopup.extend({
    _dt:0,
    _count:0,
    ctor:function(){
        this._super("res/phzAlertPop.json");
    },

    selfRender:function(){
        this.btn_agree = this.getWidget("Button_36");
        this.btn_refuse = this.getWidget("Button_37");

        this.btn_agree.loadTextureNormal("res/res_ui/homeLayer/xiaoxi/tongyi.png");
        this.btn_refuse.loadTextureNormal("res/res_ui/homeLayer/xiaoxi/jujue.png");

        this.btn_agree.setScale(1.6);
        this.btn_refuse.setScale(1.6);

        this.Button_close = this.getWidget("close_btn");
        this.Button_close.visible = false;

        UITools.addClickEvent(this.btn_agree,this,this.onOk);
        UITools.addClickEvent(this.btn_refuse,this,this.onCancel);

        this.label_tip = this.getWidget("Label_35");

        this.label_time = this.getWidget("Label_36");
        this.label_time.y -= 50;

        var Label_36 = this.getWidget("Label_36");

        this.label_time = new cc.LabelTTF("","Arial",48,cc.size(500, 50));
        this.label_time.setString("");
        this.label_time.setColor(cc.color("#FFBD5E00"));
        this.label_time.setHorizontalAlignment(cc.TEXT_ALIGNMENT_CENTER);
        this.label_time.setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER);
        this.label_time.x = Label_36.x;
        this.label_time.y = Label_36.y;
        this.getWidget("main2").addChild(this.label_time);
    },
