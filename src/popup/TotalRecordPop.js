...
var TotalRecordPop = BasePopup.extend({
    ...
    getZhanjiData:function(){
        ...
        Network.loginReqNew(505,{logType:0},function(data){
    ...
    selfRender: function () {
        ...
        this.inputBox.x = 1460 - 95;
        this.inputBox.y = 1032;
    ...
    getClubDetailData:function(idx){
        ...
        NetworkJT.loginReqNew(421, {tableNo:tableNo, oUserId:PlayerModel.userId ,isClub:1}, function (data) {
            sy.scene.hideLoading();
            if (data) {
    ...
    setLabelScore:function(label,score){
        ...
        var color = score>0?cc.color("#cd3d17"):cc.color("#20915d");
    ...
    onClickItemCheck:function(sender){
        ...
        this.scrollDetail.removeAllChildren();
        Network.loginReqNew(505,{logType:sender.logType, logId: sender.tempData.id, userId:PlayerModel.userId}, function(data){
            if(data){
    ...
    setBtnShowType:function(type){
        if(type == 2){
            ...
            this.myRecordBtn.loadTextureNormal("res/res_ui/homeLayer/zhanji/btn_zhanji.png");
