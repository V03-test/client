...
var SDHJiaoFenBtnLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        label_pf_tip.setPosition(bg.width/2,60);
        ...
        for(var i = 0;i<fenArr.length;++i){
            var btn = new ccui.Button("res/res_yybs/jf.png","res/res_yybs/jf.png");
            btn.setPosition(210 + (i%8)*offsetX,startY - Math.floor(i/8)*offSetY);
        ...
        this.checkBox_paifen = new ccui.CheckBox("res/res_yybs/pai1.png","","res/res_sdh/pai.png","","");
        this.checkBox_paifen.addEventListener(this.onClickPaiFen,this);
        this.checkBox_paifen.setPosition(bg.width - 200,startY);
        bg.addChild(this.checkBox_paifen,1);

        var btn_bujiao = new ccui.Button("res/res_yybs/anniu_bujiao_1.png","res/res_yybs/anniu_bujiao_1.png","");
        btn_bujiao.setPosition(bg.width - 200,startY - offSetY);
        ...
        this.progressBar.setPosition(bg.width/2 - 15,17);
